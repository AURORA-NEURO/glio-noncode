"""Record D453 registry decisions in an append-only D454 history.

The mixed D453 registry is the blocked baseline. A ready-only D453 registry is
...
Example::
    ...
    python examples/downloaded_data_quality_d454_runtime_registry_history_demo.py \
        artifacts/d453-real/registry \
        artifacts/d448-real/release \
        --destination artifacts/d454-real \
...
def build_demo(
    ...
    *,
    ...
    history_id: str = "glio-noncode-d454-release-history",
) -> dict[str, Any]:
    """Build, append, audit, query, and optionally persist one D454 history."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Record D453 registry decisions with D454")
    parser.add_argument("blocked_registry_directory", type=Path, help="mixed D453 registry directory")
    ...
    parser.add_argument("--history-id", default="glio-noncode-d454-release-history")
