...
from . import downloaded_data_quality_d314_runtime_registry_history as history_model
...
# D315 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d315-history-diff-v1"
BOUNDARY = "glio-noncode-d315-history-diff"
