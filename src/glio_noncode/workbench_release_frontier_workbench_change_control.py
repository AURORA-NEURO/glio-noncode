"""Independent workbench change control assurance plane.
...
class WorkbenchReleaseWorkbenchChangeControl:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_change_control(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchChangeControl:
    ...
    return WorkbenchReleaseWorkbenchChangeControl(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_change_control(receipt: WorkbenchReleaseWorkbenchChangeControl, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_change_control(receipt: WorkbenchReleaseWorkbenchChangeControl) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchChangeControl", "validate_workbench_release_workbench_change_control", "build_workbench_release_workbench_change_control", "summarize_workbench_release_workbench_change_control"]
