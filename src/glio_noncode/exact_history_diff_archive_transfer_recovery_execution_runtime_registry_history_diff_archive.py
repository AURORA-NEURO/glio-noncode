"""Portable deterministic ZIP transport for federation history diffs.

The history-diff package is already an addressed four-file public contract.
This module adds a single-file transport around that contract without
introducing source paths, private records, timestamps, or unbounded metadata.
The outer manifest is canonical and every embedded member has an independent
byte receipt.  Fixed ZIP metadata makes equal public inputs produce equal
archive bytes, which gives operators a safe handoff artifact for baseline and
...
def _embedded_name(value: Any) -> str:
    value = _text(value, "history diff archive embedded file name", 256)
...
def _embedded_diff(value: diff_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> dict[str, bytes]:
    checked = diff_model.verify_diff(value)
    items = diff_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItems(checked.items, diff_model.address_items(checked.items))
    documents = {
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact:
    """A replayable byte receipt for one fixed history-diff member."""
    ...
    def __init__(self, index: int, name: str, size: int, hash: str) -> None:
        ...
        if self.index >= len(EMBEDDED_FILES) or self.name != EMBEDDED_FILES[self.index]:
            raise ValidationError("history diff archive artifact ordering is not exact")

    def to_dict(self) -> dict[str, Any]:
        return {field: getattr(self, field) for field in self.FIELDS}

    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact:
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    """A public addressed envelope around a verified history diff."""
    ...
    def __init__(
        ...
        artifact_count: int,
        files: Sequence[str],
        artifacts: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact | Mapping[str, Any]],
        archive_size: int,
        content_address: str,
        raw: Mapping[str, bytes] | None = None,
        diff: diff_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff | None = None,
    ) -> None:
        ...
        self.artifacts = tuple(item if isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact.from_mapping(item) for item in _sequence(artifacts, "history diff archive artifacts", len(EMBEDDED_FILES)))
    ...
    def _validate(self) -> None:
        ...
        if not _public(self.to_dict()):
            raise ValidationError("history diff archive crosses the public boundary")
    ...
    @property
    def diff(self) -> diff_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff | None:
        return self._diff


def address_archive(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive):
...
def _artifact(index: int, name: str, raw: bytes) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact:
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact(index, name, len(raw), hash_bytes(raw, prefix=ARTIFACT_PREFIX))


def build_archive(value: diff_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff, *, archive_id: str = DEFAULT_ARCHIVE_ID) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    checked = diff_model.verify_diff(value)
    ...
    body = {
        ...
        "version": VERSION,
        "boundary": BOUNDARY,
        "diff_id": checked.diff_id,
        "diff_address": checked.content_address,
        "artifact_count": len(EMBEDDED_FILES),
        "files": EMBEDDED_FILES,
        "artifacts": artifacts,
        "archive_size": 1,
    }
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive(**body, content_address="pending:archive", raw=raw, diff=checked)
    content_address = address_archive(provisional)
    candidate = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive(**body, content_address=content_address, raw=raw, diff=checked)
    archive_size = len(_zip_bytes_unchecked(candidate))
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive(**(body | {"archive_size": archive_size}), content_address=content_address, raw=raw, diff=checked)


def build_archive_from_directory(directory: str | Path, *, archive_id: str = DEFAULT_ARCHIVE_ID) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    return build_archive(diff_model.load_diff(directory), archive_id=archive_id)


def archive_from_mapping(value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    value = _mapping(value, "history diff archive")
    _strict(value, set(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive.FIELDS), "history diff archive")
    artifacts = tuple(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact.from_mapping(item) for item in _sequence(value["artifacts"], "history diff archive artifacts", len(EMBEDDED_FILES)))
    result = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive(value["archive_id"], value["version"], value["boundary"], value["diff_id"], value["diff_address"], value["artifact_count"], value["files"], artifacts, value["archive_size"], value["content_address"])
    return verify_archive(result)


def verify_archive(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive):
...
def _archive_manifest(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> dict[str, Any]:
    body = {
        "version": VERSION,
        "boundary": BOUNDARY,
        ...
        "files": value.files,
        "artifacts": tuple(item.to_dict() for item in value.artifacts),
...
def manifest_document(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> dict[str, Any]:
    return _archive_manifest(verify_archive(value))


def _zip_bytes_unchecked(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> bytes:
...
def archive_bytes(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> bytes:
...
def archive_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> str:
...
def load_archive(source: str | Path | bytes) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    ...
    artifacts = tuple(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact.from_mapping(item) for item in _sequence(manifest["artifacts"], "history diff archive artifacts", len(EMBEDDED_FILES)))
    value = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive(manifest["archive_id"], manifest["version"], manifest["boundary"], manifest["diff_id"], manifest["diff_address"], manifest["artifact_count"], manifest["files"], artifacts, physical_size, manifest["archive_address"], raw={name: raw[name] for name in EMBEDDED_FILES}, diff=diff)
...
def load_archive_bytes(raw: bytes) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    return load_archive(raw)


def verify_archive_file(source: str | Path) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    return load_archive(source)


def archive_csv(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> str:
    value = verify_archive(value)
...
def render_archive_markdown(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive) -> str:
    value = verify_archive(value)
    lines = [
        "# Federation History-Diff Archive",
        "",
        f"- Archive: `{value.archive_id}`",
        f"- Diff: `{value.diff_id}`",
        f"- Diff address: `{value.diff_address}`",
        f"- ZIP bytes: `{value.archive_size}`",
        f"- Address: `{value.content_address}`",
        "",
        "| index | embedded file | bytes | receipt |",
        "| ---: | --- | ---: | --- |",
    ]
...
def artifact_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "FederationRuntimeRegistryHistoryDiffArchiveArtifact", "type": "object", "additionalProperties": False, "required": list(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact.FIELDS), "properties": {"index": {"type": "integer", "minimum": 0, "maximum": len(EMBEDDED_FILES) - 1}, "name": {"type": "string", "enum": list(EMBEDDED_FILES)}, "size": {"type": "integer", "minimum": 1}, "hash": {"type": "string", "pattern": "^" + ARTIFACT_PREFIX + ":"}}}
...
def manifest_schema() -> dict[str, Any]:
    ...
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "FederationRuntimeRegistryHistoryDiffArchiveManifest", "type": "object", "additionalProperties": False, "required": list(fields), "properties": fields}
...
def archive_schema() -> dict[str, Any]:
    ...
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "FederationRuntimeRegistryHistoryDiffArchive", "type": "object", "additionalProperties": False, "required": list(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive.FIELDS), "properties": fields}
...
__all__ = ["ARCHIVE_MANIFEST_NAME", "ARCHIVE_PREFIX", "ARTIFACT_PREFIX", "BOUNDARY", "DEFAULT_ARCHIVE_ID", "EMBEDDED_FILES", "FILES", "MANIFEST_PREFIX", "MAX_ARCHIVE_BYTES", "MAX_MEMBER_BYTES", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveArtifact", "VERSION", "address_archive", "archive_bytes", "archive_csv", "archive_from_mapping", "archive_json", "archive_schema", "artifact_schema", "build_archive", "build_archive_from_directory", "capabilities", "load_archive", "load_archive_bytes", "manifest_document", "manifest_schema", "render_archive_markdown", "verify_archive", "verify_archive_file", "write_archive"]
