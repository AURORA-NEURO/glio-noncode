"""Independent workbench execution plan assurance plane.
...
class WorkbenchReleaseWorkbenchExecutionPlan:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_execution_plan(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchExecutionPlan:
    ...
    return WorkbenchReleaseWorkbenchExecutionPlan(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_execution_plan(receipt: WorkbenchReleaseWorkbenchExecutionPlan, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_execution_plan(receipt: WorkbenchReleaseWorkbenchExecutionPlan) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchExecutionPlan", "validate_workbench_release_workbench_execution_plan", "build_workbench_release_workbench_execution_plan", "summarize_workbench_release_workbench_execution_plan"]
