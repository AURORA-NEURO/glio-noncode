...
from . import (
    downloaded_data_quality_diff_gate_remediation_resolution_history_diff_audit as diff_audit_model,
)
from . import (
...
from . import (
    downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_query as query_model,
)
from . import (
    downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_query_audit as query_audit_model,
)
from ._safe_persistence import atomic_write_text, read_text
from .errors import ValidationError
from .serialization import _strict_json_loads, canonical_json, content_hash

VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-policy-runtime-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_runtime"
RUNTIME_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff-policy-runtime"
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest:
...
def address_manifest(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime:
    FIELDS = RUNTIME_FIELDS

    def __init__(self, runtime_id: str, version: str, boundary: str, policy_id: str, policy_address: str, evaluation_id: str, evaluation_address: str, diff_address: str, audit_address: str, query_address: str, query_audit_address: str, direction: str, state: str, decision: str, accepted: bool, release_ready: bool, passed_rule_count: int, failed_rule_count: int, manifest: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest | Mapping[str, Any], diff: diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff | Mapping[str, Any], policy: policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicy | Mapping[str, Any], evaluation: policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyEvaluation | Mapping[str, Any], audit: diff_audit_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffAudit | Mapping[str, Any], query: query_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery | Mapping[str, Any], query_audit: query_audit_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit | Mapping[str, Any], content_address: str) -> None:
        ...
        self.manifest = manifest if isinstance(manifest, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest.from_mapping(manifest)
        self.diff = diff if isinstance(diff, diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff) else diff_model.diff_from_mapping(diff)
        self.policy = policy if isinstance(policy, policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicy) else policy_model.policy_from_mapping(policy)
        self.evaluation = evaluation if isinstance(evaluation, policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyEvaluation) else policy_model.evaluation_from_mapping(evaluation)
        self.audit = audit if isinstance(audit, diff_audit_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffAudit) else diff_audit_model.audit_from_mapping(audit)
        self.query = query if isinstance(query, query_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery) else query_model.query_from_mapping(query)
        self.query_audit = query_audit if isinstance(query_audit, query_audit_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit) else query_audit_model.audit_from_mapping(query_audit)
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime:
        value = _mapping(value, "history diff policy runtime")
        _strict(value, set(cls.FIELDS), "history diff policy runtime")
        return cls(*(value[field] for field in cls.FIELDS))


def address_runtime(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime):
...
def build_runtime(diff: diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff, *, policy: policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicy | None = None, runtime_id: str = DEFAULT_RUNTIME_ID, evaluation_id: str = policy_model.EVALUATION_PREFIX, resources: Sequence[str] = query_model.RESOURCES, resource: str = "", rule_id: str = "", passed: bool | None = None, text: str = "", offset: int = 0, limit: int = query_model.MAX_LIMIT) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime:
    ...
    if not isinstance(policy, policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicy):
    ...
    manifest_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest(**manifest_body, content_address=MANIFEST_PREFIX + ":pending")
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest(**manifest_body, content_address=address_manifest(manifest_provisional))
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime(**body, content_address=RUNTIME_PREFIX + ":pending")
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime(**body, content_address=address_runtime(provisional))


def runtime_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime.from_mapping(value)


def runtime_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime) -> str:
    return canonical_json(runtime_from_mapping(value.to_dict()).to_dict())


def runtime_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime) -> str:
...
def render_runtime_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime) -> str:
    value = runtime_from_mapping(value.to_dict())
...
def persist_runtime(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime, destination: str | Path, *, overwrite: bool = False) -> Path:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime):
...
def _read_json(path: Path) -> Mapping[str, Any]:
    try:
        value = _strict_json_loads(read_text(path, field="quality diff gate policy runtime artifact"))
...
def load_runtime(destination: str | Path) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime:
    destination = Path(destination)
    ...
    runtime = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime.from_mapping(_read_json(destination / "runtime.json"))
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest.from_mapping(_read_json(destination / "manifest.json"))
...
def run_runtime(diff: diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff, *, policy: policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicy | None = None, runtime_id: str = DEFAULT_RUNTIME_ID, evaluation_id: str = policy_model.EVALUATION_PREFIX, resources: Sequence[str] = query_model.RESOURCES, resource: str = "", rule_id: str = "", passed: bool | None = None, text: str = "", offset: int = 0, limit: int = query_model.MAX_LIMIT, destination: str | Path | None = None, overwrite: bool = False) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime:
...
__all__ = ["BOUNDARY", "DEFAULT_RUNTIME_ID", "FILES", "MANIFEST_ARTIFACT_FILES", "MANIFEST_FIELDS", "MAX_ARTIFACTS", "RUNTIME_FIELDS", "RUNTIME_PREFIX", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeManifest", "address_manifest", "address_runtime", "build_runtime", "capabilities", "load_runtime", "manifest_schema", "persist_runtime", "render_runtime_markdown", "run_runtime", "runtime_csv", "runtime_from_mapping", "runtime_json", "runtime_schema"]
