...
VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-policy-query-audit-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_query_audit"
AUDIT_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff-policy-query-audit"
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck:
    FIELDS = CHECK_FIELDS
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck:
...
def address_check(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck):
        raise ValidationError("history diff policy query audit check address requires a typed check")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=CHECK_PREFIX)


class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit:
    FIELDS = AUDIT_FIELDS

    def __init__(self, query_address: str, checks: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck | Mapping[str, Any]], check_count: int, passed_count: int, failed_count: int, accepted: bool, content_address: str) -> None:
        self.query_address = _address(query_address, "history diff policy query audit query address", query_model.QUERY_PREFIX)
        self.checks = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck.from_mapping(item) for item in _sequence(checks, "history diff policy query audit checks", MAX_CHECKS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit:
        value = _mapping(value, "history diff policy query audit")
        _strict(value, set(cls.FIELDS), "history diff policy query audit")
        return cls(*(value[field] for field in cls.FIELDS))


def address_audit(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit):
        raise ValidationError("history diff policy query audit address requires a typed audit")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=AUDIT_PREFIX)


def _check(ordinal: int, check_id: str, passed: bool, detail: str, evidence: Sequence[str]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck(**(body | {"content_address": address_check(provisional)}))


def _matches(row: query_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow, query: query_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery) -> bool:
...
def audit_query(value: query_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit:
    if not isinstance(value, query_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery):
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit(**(body | {"content_address": address_audit(provisional)}))


def audit_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit.from_mapping(value)


def audit_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit) -> str:
    return canonical_json(audit_from_mapping(value.to_dict()).to_dict())


def audit_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit) -> str:
...
def render_audit_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit) -> str:
    value = audit_from_mapping(value.to_dict())
...
def check_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy query audit check", "type": "object", "additionalProperties": False, "required": list(CHECK_FIELDS), "properties": {"ordinal": {"type": "integer", "minimum": 1}, "check_id": {"enum": list(CHECK_IDS)}, "passed": {"type": "boolean"}, "detail": {"type": "string"}, "evidence_addresses": {"type": "array", "items": {"type": "string"}, "minItems": 1, "maxItems": 8}, "content_address": {"type": "string"}}}


def audit_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy query audit", "type": "object", "additionalProperties": False, "required": list(AUDIT_FIELDS), "properties": {"query_address": {"type": "string"}, "checks": {"type": "array", "items": check_schema(), "minItems": MAX_CHECKS, "maxItems": MAX_CHECKS}, "check_count": {"type": "integer", "minimum": MAX_CHECKS, "maximum": MAX_CHECKS}, "passed_count": {"type": "integer", "minimum": 0, "maximum": MAX_CHECKS}, "failed_count": {"type": "integer", "minimum": 0, "maximum": MAX_CHECKS}, "accepted": {"type": "boolean"}, "content_address": {"type": "string"}}}
...
__all__ = ["AUDIT_FIELDS", "AUDIT_PREFIX", "BOUNDARY", "CHECK_FIELDS", "CHECK_IDS", "CHECK_PREFIX", "MAX_CHECKS", "VERSION", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAudit", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryAuditCheck", "address_audit", "address_check", "audit_csv", "audit_from_mapping", "audit_json", "audit_query", "audit_schema", "capabilities", "check_schema", "render_audit_markdown"]
