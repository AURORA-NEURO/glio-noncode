"""Independent workbench thresholds assurance plane.
...
class WorkbenchReleaseWorkbenchThresholds:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_thresholds(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchThresholds:
    ...
    return WorkbenchReleaseWorkbenchThresholds(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_thresholds(receipt: WorkbenchReleaseWorkbenchThresholds, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_thresholds(receipt: WorkbenchReleaseWorkbenchThresholds) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchThresholds", "validate_workbench_release_workbench_thresholds", "build_workbench_release_workbench_thresholds", "summarize_workbench_release_workbench_thresholds"]
