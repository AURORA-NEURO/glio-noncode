"""source citation summary for aggregate receipts."""
...
class ValidationDesignSourceCitationsPlane:
    plane_id: str
    values: dict[str, Any]
    accepted: bool
    content_address: str
...
def build_validation_design_source_citations(**kwargs: Any) -> ValidationDesignSourceCitationsPlane:
    ...
    return ValidationDesignSourceCitationsPlane(**body, content_address=content_hash(body))

__all__ = ["ValidationDesignSourceCitationsPlane", "build_validation_design_source_citations"]
