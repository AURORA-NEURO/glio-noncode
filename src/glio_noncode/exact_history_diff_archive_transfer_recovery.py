...
def _actions(transfer: transfer_model.HistoryDiffArchiveTransfer, missing: Sequence[int]) -> tuple[ExactHistoryDiffArchiveTransferRecoveryAction, ...]:
    actions = []
...
def build_recovery(value: transfer_model.HistoryDiffArchiveTransfer | transfer_model.HistoryDiffArchiveTransferAssembler, *, recovery_id: str = DEFAULT_RECOVERY_ID, checkpointed: bool = False) -> ExactHistoryDiffArchiveTransferRecovery:
