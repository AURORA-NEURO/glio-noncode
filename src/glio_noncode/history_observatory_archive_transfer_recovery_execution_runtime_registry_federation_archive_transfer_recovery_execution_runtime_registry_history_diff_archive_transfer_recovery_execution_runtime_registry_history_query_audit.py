...
from . import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_runtime_registry_history_query as query_model
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck:
...
def address_check(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck):
        raise ValidationError("runtime registry history query audit check address requires a typed check")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=CHECK_PREFIX)


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit:
    """A fixed-size independently recomputed query audit."""

    FIELDS = AUDIT_FIELDS

    def __init__(self, query_address: str, history_address: str, history_id: str, query_id: str, version: str, boundary: str, check_count: int, passed_count: int, failed_count: int, accepted: bool, checks: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.checks = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck.from_mapping(item) for item in _sequence(checks, "runtime registry history query audit checks", MAX_CHECKS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit:
...
def address_audit(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit):
        raise ValidationError("runtime registry history query audit address requires a typed audit")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=AUDIT_PREFIX)


def _check(check_id: str, passed: bool, detail: str, evidence: Sequence[str]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck(**(body | {"content_address": address_check(provisional)}))


def audit_query(value: query_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery, history: history_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit(**(body | {"content_address": address_audit(provisional)}))


def verify_audit(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit):
        raise ValidationError("runtime registry history query audit verification requires a typed audit")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit.from_mapping(value.to_dict())


def audit_from_mapping(value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit:
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit.from_mapping(value)


def audit_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit) -> str:
    return canonical_json(verify_audit(value).to_dict())


def audit_csv(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit) -> str:
...
def render_audit_markdown(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit) -> str:
    value = verify_audit(value)
...
__all__ = ["VERSION", "BOUNDARY", "AUDIT_PREFIX", "CHECK_PREFIX", "CHECK_IDS", "CHECK_FIELDS", "AUDIT_FIELDS", "MAX_CHECKS", "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAuditCheck", "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryAudit", "address_check", "address_audit", "audit_query", "verify_audit", "audit_from_mapping", "audit_json", "audit_csv", "render_audit_markdown", "check_schema", "audit_schema", "capabilities"]
