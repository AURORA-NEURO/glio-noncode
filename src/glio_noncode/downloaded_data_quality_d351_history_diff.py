...
from . import downloaded_data_quality_d350_runtime_registry_history as history_model
...
# D351 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d351-history-diff-v1"
BOUNDARY = "glio-noncode-d351-history-diff"
