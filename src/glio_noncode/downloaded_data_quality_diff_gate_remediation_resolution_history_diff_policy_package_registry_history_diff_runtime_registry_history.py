...
from . import downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_package_registry_history_diff_runtime_registry as registry_model
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry:
        value = _mapping(value, "runtime registry history entry")
        _strict(value, set(cls.FIELDS), "runtime registry history entry")
        return cls(*(value[field] for field in cls.FIELDS))


def address_entry(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry):
...
def entry_from_registry(value: registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistry, ordinal: int, transition: str, previous_registry_address: str) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry:
    if not isinstance(value, registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistry):
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry(**(body | {"content_address": address_entry(provisional)}))


class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntries:
    """Ordered and addressed snapshot projection persisted beside a history."""

    FIELDS = ENTRIES_FIELDS

    def __init__(self, entries: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry | Mapping[str, Any]], content_address: str) -> None:
        self.entries = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry.from_mapping(item) for item in _sequence(entries, "runtime registry history entries", MAX_ENTRIES))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntries:
...
def address_entries(value: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry]) -> str:
    typed = tuple(value)
    if any(not isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry) for item in typed):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest:
        value = _mapping(value, "runtime registry history manifest")
        _strict(value, set(cls.FIELDS), "runtime registry history manifest")
        return cls(*(value[field] for field in cls.FIELDS))


def address_manifest(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary:
        value = _mapping(value, "runtime registry history summary")
        _strict(value, set(cls.FIELDS), "runtime registry history summary")
        return cls(*(value[field] for field in cls.FIELDS))


def address_summary(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory:
    """Deterministic append-only history of one registry identity."""

    FIELDS = HISTORY_FIELDS

    def __init__(self, history_id: str, registry_id: str, version: str, boundary: str, entry_count: int, latest_registry_address: str, latest_entry_count: int, latest_accepted_count: int, latest_ready_count: int, latest_blocked_count: int, initial_count: int, improved_count: int, regressed_count: int, unchanged_count: int, changed_count: int, state: str, accepted: bool, manifest: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest | Mapping[str, Any], summary: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary | Mapping[str, Any], entries: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.manifest = manifest if isinstance(manifest, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest.from_mapping(manifest)
        self.summary = summary if isinstance(summary, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary.from_mapping(summary)
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory:
        value = _mapping(value, "runtime registry history")
        _strict(value, set(cls.FIELDS), "runtime registry history")
        return cls(*(value[field] for field in cls.FIELDS))


def address_history(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory):
...
def build_history(registries: Sequence[registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistry], *, history_id: str = DEFAULT_HISTORY_ID) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory:
    typed = tuple(_sequence(registries, "runtime registry history registries", MAX_ENTRIES))
    if any(not isinstance(item, registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistry) for item in typed):
    ...
    entries: list[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry] = []
    previous: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry | None = None
    ...
    summary_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary(**summary_body)
    summary = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary(**(summary_body | {"content_address": address_summary(summary_provisional)}))
    ...
    manifest_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest(**manifest_body)
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest(**(manifest_body | {"content_address": address_manifest(manifest_provisional)}))
    body = {
        "history_id": history_id,
        "registry_id": registry_id,
        "version": VERSION,
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory(**(body | {"content_address": address_history(provisional)}))


def verify_history(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory):
        raise ValidationError("runtime registry history verification requires a typed history")
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory.from_mapping(value.to_dict())


def history_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory.from_mapping(value)


def history_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory) -> str:
    return canonical_json(verify_history(value).to_dict())


def history_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory) -> str:
...
def render_history_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory) -> str:
    value = verify_history(value)
    lines = [
...
def entries_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntries) -> str:
    return canonical_json(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntries.from_mapping(value.to_dict()).to_dict())


def summary_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary) -> str:
    return canonical_json(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary.from_mapping(value.to_dict()).to_dict())


def manifest_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest) -> str:
    return canonical_json(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest.from_mapping(value.to_dict()).to_dict())
...
def persist_history(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory, destination: str | Path, *, overwrite: bool = False) -> Path:
    value = verify_history(value)
    ...
    try:
        entries = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntries(value.entries, address_entries(value.entries))
...
def load_history(destination: str | Path) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory:
    destination = Path(destination)
    try:
    ...
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest.from_mapping(documents["manifest.json"])
    entries = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntries.from_mapping(documents["entries.json"])
    summary = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary.from_mapping(documents["summary.json"])
...
def run_history(registries: Sequence[registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistry], *, history_id: str = DEFAULT_HISTORY_ID, destination: str | Path | None = None, overwrite: bool = False) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory:
...
__all__ = ["VERSION", "BOUNDARY", "HISTORY_PREFIX", "ENTRY_PREFIX", "ENTRIES_PREFIX", "MANIFEST_PREFIX", "SUMMARY_PREFIX", "DEFAULT_HISTORY_ID", "FILES", "ARTIFACT_FILES", "MANIFEST_ARTIFACT_FILES", "TRANSITIONS", "STATES", "MAX_ENTRIES", "MAX_HISTORY_BYTES", "ENTRY_FIELDS", "ENTRIES_FIELDS", "MANIFEST_FIELDS", "SUMMARY_FIELDS", "HISTORY_FIELDS", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntry", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryEntries", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryManifest", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistorySummary", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistory", "address_entry", "address_entries", "address_manifest", "address_summary", "address_history", "entry_from_registry", "build_history", "verify_history", "history_from_mapping", "history_json", "history_csv", "render_history_markdown", "entries_json", "summary_json", "manifest_json", "persist_history", "load_history", "run_history", "entry_schema", "entries_schema", "manifest_schema", "summary_schema", "history_schema", "capabilities"]
