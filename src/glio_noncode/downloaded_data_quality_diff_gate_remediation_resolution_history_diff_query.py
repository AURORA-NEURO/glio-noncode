...
VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-query-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff_query"
QUERY_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff-query"
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow:
    FIELDS = ROW_FIELDS
    ...
    def __init__(self, ordinal: int, resource: str, identity: str, change: str, changed_attributes: Sequence[str], left_address: str, right_address: str, content_address: str) -> None:
        ...
        self.left_address = _address(left_address, "history diff query row left address", "glio-noncode-download-quality-diff-gate-remediation-resolution-history-entry", required=False)
        self.right_address = _address(right_address, "history diff query row right address", "glio-noncode-download-quality-diff-gate-remediation-resolution-history-entry", required=False)
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow:
        value = _mapping(value, "history diff query row")
        _strict(value, set(cls.FIELDS), "history diff query row")
        return cls(*(value[field] for field in cls.FIELDS))


def address_row(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery:
    ...
    def __init__(self, diff_address: str, version: str, boundary: str, resources: Sequence[str], resource: str, change: str, direction: str, identity: str, text: str, offset: int, limit: int, total_count: int, matched_count: int, returned_count: int, next_offset: int, truncated: bool, rows: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.rows = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow.from_mapping(item) for item in _sequence(rows, "history diff query rows", MAX_LIMIT))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery:
        value = _mapping(value, "history diff query")
        _strict(value, set(cls.FIELDS), "history diff query")
        return cls(*(value[field] for field in cls.FIELDS))


def address_query(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery):
        raise ValidationError("history diff query address requires a typed query")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=QUERY_PREFIX)


def _summary_row(value: diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow(**(body | {"content_address": address_row(provisional)}))


def _item_row(value: diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem, ordinal: int) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow:
...
def _matches(row: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow, query: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery) -> bool:
...
def query_diff(value: diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff, *, resources: Sequence[str] = RESOURCES, resource: str = "", change: str = "", direction: str = "", identity: str = "", text: str = "", offset: int = 0, limit: int = MAX_LIMIT) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery:
    if not isinstance(value, diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff):
        raise ValidationError("history diff query requires a typed diff")
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery(value.content_address, VERSION, BOUNDARY, resources, resource, change, direction, identity, text, offset, limit, 0, 0, 0, offset, False, (), QUERY_PREFIX + ":pending")
    ...
    provisional_result = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery(**(body | {"content_address": address_query(provisional_result)}))


def _readdress(row: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow, ordinal: int) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow:
    body = row.to_dict() | {"ordinal": ordinal, "content_address": ROW_PREFIX + ":pending"}
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow(**(body | {"content_address": address_row(provisional)}))


def query_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery.from_mapping(value)


def query_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery) -> str:
    return canonical_json(query_from_mapping(value.to_dict()).to_dict())


def query_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery) -> str:
...
def render_query_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery) -> str:
    value = query_from_mapping(value.to_dict())
...
def row_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff query row", "type": "object", "additionalProperties": False, "required": list(ROW_FIELDS), "properties": {"ordinal": {"type": "integer", "minimum": 1}, "resource": {"enum": list(RESOURCES)}, "identity": {"type": "string"}, "change": {"enum": list(diff_model.CHANGES)}, "changed_attributes": {"type": "array", "items": {"enum": list(diff_model.CHANGED_ATTRIBUTES)}}, "left_address": {"type": "string"}, "right_address": {"type": "string"}, "content_address": {"type": "string"}}}


def query_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff query", "type": "object", "additionalProperties": False, "required": list(QUERY_FIELDS), "properties": {"diff_address": {"type": "string"}, "version": {"const": VERSION}, "boundary": {"const": BOUNDARY}, "resources": {"type": "array", "items": {"enum": list(RESOURCES)}}, "resource": {"type": "string"}, "change": {"type": "string"}, "direction": {"type": "string"}, "identity": {"type": "string"}, "text": {"type": "string"}, "offset": {"type": "integer", "minimum": 0}, "limit": {"type": "integer", "minimum": 1}, "total_count": {"type": "integer", "minimum": 0}, "matched_count": {"type": "integer", "minimum": 0}, "returned_count": {"type": "integer", "minimum": 0}, "next_offset": {"type": "integer", "minimum": 0}, "truncated": {"type": "boolean"}, "rows": {"type": "array", "items": row_schema(), "maxItems": MAX_LIMIT}, "content_address": {"type": "string"}}}
...
__all__ = ["BOUNDARY", "MAX_LIMIT", "MAX_TOTAL_COUNT", "QUERY_FIELDS", "QUERY_PREFIX", "RESOURCES", "ROW_FIELDS", "ROW_PREFIX", "VERSION", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQuery", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffQueryRow", "address_query", "address_row", "capabilities", "query_csv", "query_diff", "query_from_mapping", "query_json", "query_schema", "render_query_markdown", "row_schema"]
