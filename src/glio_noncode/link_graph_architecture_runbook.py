"""D10 stage and module runbook projections."""
...
def link_graph_architecture_runbook(
...
def link_graph_architecture_stage_runbook() -> tuple[dict[str, object], ...]:
    names = (
        "fixture-loaded",
        "sources-audited",
        "schema-validated",
...
def link_graph_architecture_module_inventory() -> tuple[str, ...]:
    return (
        "contracts",
        "public_data",
        "operations",
