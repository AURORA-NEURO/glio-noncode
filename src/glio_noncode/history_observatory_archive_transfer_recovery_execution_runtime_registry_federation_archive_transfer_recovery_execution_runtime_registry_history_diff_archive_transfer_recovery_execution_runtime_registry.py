...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry:
        value = _mapping(value, "runtime registry entry")
        _strict(value, set(cls.FIELDS), "runtime registry entry")
        return cls(*(value[field] for field in cls.FIELDS))


def address_entry(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry):
...
def entry_from_runtime(value: runtime_model.HistoryDiffArchiveTransferRecoveryExecutionRuntime, ordinal: int) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry:
    if not isinstance(value, runtime_model.HistoryDiffArchiveTransferRecoveryExecutionRuntime):
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry(**(body | {"content_address": address_entry(provisional)}))


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntries:
    """Ordered and addressed entry projection persisted beside a registry."""

    FIELDS = ENTRIES_FIELDS

    def __init__(self, entries: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry | Mapping[str, Any]], content_address: str) -> None:
        self.entries = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry.from_mapping(item) for item in _sequence(entries, "runtime registry entries", MAX_ENTRIES))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntries:
...
def address_entries(value: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry]) -> str:
    typed = tuple(value)
    if any(not isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry) for item in typed):
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest:
        value = _mapping(value, "runtime registry manifest")
        _strict(value, set(cls.FIELDS), "runtime registry manifest")
        return cls(*(value[field] for field in cls.FIELDS))


def address_manifest(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest):
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary:
        value = _mapping(value, "runtime registry summary")
        _strict(value, set(cls.FIELDS), "runtime registry summary")
        return cls(*(value[field] for field in cls.FIELDS))


def address_summary(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary):
...
def _state(entries: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry]) -> str:
    if not entries:
        return "empty"
    return "ready" if all(item.accepted for item in entries) else "blocked"


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry:
    """Deterministic multi-runtime admission for the target runtime family."""

    FIELDS = REGISTRY_FIELDS

    def __init__(self, registry_id: str, version: str, boundary: str, entry_count: int, accepted_count: int, ready_count: int, blocked_count: int, state: str, accepted: bool, manifest: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest | Mapping[str, Any], summary: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary | Mapping[str, Any], entries: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.manifest = manifest if isinstance(manifest, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest.from_mapping(manifest)
        self.summary = summary if isinstance(summary, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary.from_mapping(summary)
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry:
        value = _mapping(value, "runtime registry")
        _strict(value, set(cls.FIELDS), "runtime registry")
        return cls(*(value[field] for field in cls.FIELDS))


def address_registry(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry):
...
def build_registry(runtimes: Sequence[runtime_model.HistoryDiffArchiveTransferRecoveryExecutionRuntime], *, registry_id: str = DEFAULT_REGISTRY_ID) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry:
    runtimes = tuple(_sequence(runtimes, "runtime registry runtimes", MAX_ENTRIES))
    if any(not isinstance(item, runtime_model.HistoryDiffArchiveTransferRecoveryExecutionRuntime) for item in runtimes):
    ...
    summary_provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary(**summary_body)
    summary = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary(**(summary_body | {"content_address": address_summary(summary_provisional)}))
    ...
    manifest_provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest(**manifest_body)
    manifest = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest(**(manifest_body | {"content_address": address_manifest(manifest_provisional)}))
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry(**body, content_address=REGISTRY_PREFIX + ":pending")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry(**body, content_address=address_registry(provisional))


def verify_registry(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry):
        raise ValidationError("runtime registry verification requires a typed registry")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry.from_mapping(value.to_dict())


def registry_from_mapping(value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry:
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry.from_mapping(value)


def registry_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) -> str:
    return canonical_json(verify_registry(value).to_dict())


def registry_csv(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) -> str:
...
def render_registry_markdown(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) -> str:
    value = verify_registry(value)
...
def entries_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntries) -> str:
    return canonical_json(HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntries.from_mapping(value.to_dict()).to_dict())


def summary_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary) -> str:
    return canonical_json(HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary.from_mapping(value.to_dict()).to_dict())


def manifest_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest) -> str:
    return canonical_json(HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest.from_mapping(value.to_dict()).to_dict())
...
def persist_registry(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry, destination: str | Path, *, overwrite: bool = False) -> Path:
    value = verify_registry(value)
    ...
    try:
        entries = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntries(value.entries, address_entries(value.entries))
...
def load_registry(destination: str | Path) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry:
    destination = Path(destination)
    ...
    manifest = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest.from_mapping(documents["manifest.json"])
    entries = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntries.from_mapping(documents["entries.json"])
    summary = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary.from_mapping(documents["summary.json"])
...
def entry_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntry", "type": "object", "additionalProperties": False, "required": list(ENTRY_FIELDS), "properties": {field: {"type": ["integer", "string", "boolean"]} for field in ENTRY_FIELDS}}


def entries_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryEntries", "type": "object", "additionalProperties": False, "required": list(ENTRIES_FIELDS), "properties": {"entries": {"type": "array", "items": entry_schema()}, "content_address": {"type": "string"}}}


def manifest_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryManifest", "type": "object", "additionalProperties": False, "required": list(MANIFEST_FIELDS), "properties": {"registry_id": {"type": "string"}, "version": {"type": "string"}, "boundary": {"type": "string"}, "files": {"type": "array", "items": {"type": "string"}}, "artifact_addresses": {"type": "array", "items": {"type": "string"}}, "content_address": {"type": "string"}}}


def summary_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistrySummary", "type": "object", "additionalProperties": False, "required": list(SUMMARY_FIELDS), "properties": {"registry_id": {"type": "string"}, "entry_count": {"type": "integer", "minimum": 0}, "accepted_count": {"type": "integer", "minimum": 0}, "ready_count": {"type": "integer", "minimum": 0}, "blocked_count": {"type": "integer", "minimum": 0}, "state": {"enum": list(STATES)}, "accepted": {"type": "boolean"}, "content_address": {"type": "string"}}}
...
def registry_schema() -> dict[str, Any]:
    ...
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry", "type": "object", "additionalProperties": False, "required": list(REGISTRY_FIELDS), "properties": properties}
