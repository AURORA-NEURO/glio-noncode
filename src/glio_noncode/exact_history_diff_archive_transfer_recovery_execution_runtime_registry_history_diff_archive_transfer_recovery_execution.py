...
def build_execution_from_assembler(recovery: recovery_model.ExactHistoryDiffArchiveTransferRecovery, assembler: transfer_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferAssembler, *, execution_id: str = DEFAULT_EXECUTION_ID, checkpointed: bool = True) -> ExactHistoryDiffArchiveTransferRecoveryExecution:
    if not isinstance(recovery, recovery_model.ExactHistoryDiffArchiveTransferRecovery) or not isinstance(assembler, transfer_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferAssembler):
