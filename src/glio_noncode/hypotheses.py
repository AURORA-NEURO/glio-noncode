...
from .expression_claims import RNAElementGeneTarget, match_rna_consequences
...
class HypothesisBuilder:
    ...
    def _build_one(
        ...
        for gene_id in element.target_genes or ("unresolved_gene",):
            ...
            graph.extend(rna_claims_by_edge.get(edge_id, ()))
        ...
        for state_id in element.state_ids or ("unresolved_state",):
            ...
            state_claim = make_claim(
                ...
                payload={
                    "state_id": state_id,
                    "state_definition": element.annotations.get("state_definition", "unspecified"),
                },
            )
            ...
            sorted(
                {
                    ...
                    if claim.edge_id in {edge.edge_id for edge in edges}
                    and claim.state
                    in (
