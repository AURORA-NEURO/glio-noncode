"""Independent workbench source registry assurance plane.
...
class WorkbenchReleaseWorkbenchSourceRegistry:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_source_registry(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchSourceRegistry:
    ...
    return WorkbenchReleaseWorkbenchSourceRegistry(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_source_registry(receipt: WorkbenchReleaseWorkbenchSourceRegistry, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_source_registry(receipt: WorkbenchReleaseWorkbenchSourceRegistry) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchSourceRegistry", "validate_workbench_release_workbench_source_registry", "build_workbench_release_workbench_source_registry", "summarize_workbench_release_workbench_source_registry"]
