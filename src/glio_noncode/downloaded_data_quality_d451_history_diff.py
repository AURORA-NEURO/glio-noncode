...
from . import downloaded_data_quality_d450_runtime_registry_history as history_model
...
# D451 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d451-history-diff-v1"
BOUNDARY = "glio-noncode-d451-history-diff"
