"""Independent accessibility audit assurance plane.
...
class WorkbenchReleaseAccessibilityAudit:
    count: int
    accepted: bool
...
def build_workbench_release_accessibility_audit(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseAccessibilityAudit:
    ...
    return WorkbenchReleaseAccessibilityAudit(**body, content_address=content_hash(body))


def validate_workbench_release_accessibility_audit(receipt: WorkbenchReleaseAccessibilityAudit, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_accessibility_audit(receipt: WorkbenchReleaseAccessibilityAudit) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseAccessibilityAudit", "validate_workbench_release_accessibility_audit", "build_workbench_release_accessibility_audit", "summarize_workbench_release_accessibility_audit"]
