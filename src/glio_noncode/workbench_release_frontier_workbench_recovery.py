"""Independent workbench recovery assurance plane.
...
class WorkbenchReleaseWorkbenchRecovery:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_recovery(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchRecovery:
    ...
    return WorkbenchReleaseWorkbenchRecovery(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_recovery(receipt: WorkbenchReleaseWorkbenchRecovery, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_recovery(receipt: WorkbenchReleaseWorkbenchRecovery) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchRecovery", "validate_workbench_release_workbench_recovery", "build_workbench_release_workbench_recovery", "summarize_workbench_release_workbench_recovery"]
