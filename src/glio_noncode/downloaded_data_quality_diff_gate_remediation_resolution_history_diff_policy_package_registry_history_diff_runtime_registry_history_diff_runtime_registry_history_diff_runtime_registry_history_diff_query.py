"""Bounded evidence queries for downloaded data quality runtime-registry history diffs."""
...
from . import downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_package_registry_history_diff_runtime_registry_history_diff_runtime_registry_history_diff_runtime_registry_history_diff as diff_model
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow:
...
def address_row(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow):
...
def _row(resource: str, key: str, value: Any, address: str, change: str, left_address: str, right_address: str, ordinal: int) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow(**(body | {"row_address": address_row(provisional)}))


def _all_rows(value: diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiff) -> tuple[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow, ...]:
    value = diff_model.verify_diff(value)
    rows: list[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow] = []
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery:
    ...
    def __init__(self, query_id: str, diff_id: str, diff_address: str, resources: Sequence[str], change_filter: str, key_filter: str, text_filter: str, offset: int, limit: int, total_count: int, returned_count: int, truncated: bool, rows: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.rows = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow.from_mapping(item) for item in _sequence(rows, "runtime registry history diff query rows", MAX_LIMIT))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery:
        value = _mapping(value, "runtime registry history diff query")
        _strict(value, set(cls.FIELDS), "runtime registry history diff query")
        return cls(*(value[field] for field in cls.FIELDS))


def address_query(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery):
        raise ValidationError("runtime registry history diff query address requires a typed query")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=QUERY_PREFIX)


def query_history_diff(value: diff_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiff, *, resources: Sequence[str] | None = None, change: str = "", key: str = "", text: str = "", offset: int = 0, limit: int = MAX_LIMIT, query_id: str = DEFAULT_QUERY_ID) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery:
    value = diff_model.verify_diff(value)
    ...
    projected = tuple(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow(item.ordinal, item.resource, item.key, item.value, item.address, item.change, item.left_address, item.right_address, item.row_address) for item in page)
    projected = tuple(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow(index, item.resource, item.key, item.value, item.address, item.change, item.left_address, item.right_address, ROW_PREFIX + ":pending") for index, item in enumerate(projected, 1))
    final_rows: list[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow] = []
    for item in projected:
        body = item.to_dict()
        final_rows.append(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQueryRow(**(body | {"row_address": address_row(item)})))
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery(**(body | {"content_address": address_query(provisional)}))


def verify_query(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery):
        raise ValidationError("runtime registry history diff query verification requires a typed query")
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery.from_mapping(value.to_dict())


def query_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery.from_mapping(value)


def query_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery) -> str:
    return canonical_json(verify_query(value).to_dict())


def query_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffRuntimeRegistryHistoryDiffQuery) -> str:
