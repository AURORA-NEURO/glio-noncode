"""Detailed source lineage plane for the D14 C13-C16 release boundary.
...
class EvidenceReleaseSourceLineage:
    edge_count: int
    accepted: bool
...
def build_evidence_release_source_lineage(values: Iterable[Any] = (), *, required: int = 1) -> EvidenceReleaseSourceLineage:
    ...
    return EvidenceReleaseSourceLineage(
        **body,
        content_address=content_hash(body),
    )


def validate_evidence_release_source_lineage(receipt: EvidenceReleaseSourceLineage, *, expected: int | None = None) -> bool:
...
def summarize_source_lineage(receipt: EvidenceReleaseSourceLineage) -> Mapping[str, Any]:
...
__all__ = ["EvidenceReleaseSourceLineage", "validate_evidence_release_source_lineage", "build_evidence_release_source_lineage", "summarize_source_lineage"]
