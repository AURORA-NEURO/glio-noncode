"""Independent assurance for history-diff archive-transfer recovery-execution runtime-registry history-diff queries."""
...
from . import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_runtime_registry_history_diff_query as query_model
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck:
...
def address_check(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck):
        raise ValidationError("runtime registry history diff query audit check address requires a typed check")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=CHECK_PREFIX)


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit:
    """A fixed-size independently recomputed query audit."""

    FIELDS = AUDIT_FIELDS

    def __init__(self, query_address: str, diff_address: str, diff_id: str, query_id: str, version: str, boundary: str, check_count: int, passed_count: int, failed_count: int, accepted: bool, checks: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.checks = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck.from_mapping(item) for item in _sequence(checks, "runtime registry history diff query audit checks", MAX_CHECKS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit:
...
def address_audit(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit):
        raise ValidationError("runtime registry history diff query audit address requires a typed audit")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=AUDIT_PREFIX)


def _check(check_id: str, passed: bool, detail: str, evidence: Sequence[str]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAuditCheck(**(body | {"content_address": address_check(provisional)}))


def _membership(query: query_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQuery, diff: diff_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> bool:
...
def _semantics(row: query_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryRow, diff: diff_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> bool:
...
def audit_query(value: query_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQuery, diff: diff_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit(**audit_body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit(**(audit_body | {"content_address": address_audit(provisional)}))


def verify_audit(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit):
        raise ValidationError("runtime registry history diff query audit verification requires a typed audit")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit.from_mapping(value.to_dict())


def audit_from_mapping(value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit:
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit.from_mapping(value)


def audit_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit) -> str:
    return canonical_json(verify_audit(value).to_dict())


def audit_csv(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffQueryAudit) -> str:
