"""Deep accessibility conformance receipt for workbench release review.
...
class WorkbenchReleaseAccessibilityConformance:
...
def build_workbench_release_accessibility_conformance(values: Iterable[Any] = (), *, require_non_empty: bool = True) -> WorkbenchReleaseAccessibilityConformance:
    rows = tuple(
        {
            "sequence": index,
    ...
    return WorkbenchReleaseAccessibilityConformance(**body, content_address=content_hash(body))


def validate_workbench_release_accessibility_conformance(receipt: WorkbenchReleaseAccessibilityConformance) -> bool:
...
__all__ = ["WorkbenchReleaseAccessibilityConformance", "build_workbench_release_accessibility_conformance", "validate_workbench_release_accessibility_conformance"]
