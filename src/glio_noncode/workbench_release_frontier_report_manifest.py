"""Independent report manifest assurance plane.
...
class WorkbenchReleaseReportManifest:
    count: int
    accepted: bool
...
def build_workbench_release_report_manifest(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseReportManifest:
    ...
    return WorkbenchReleaseReportManifest(**body, content_address=content_hash(body))


def validate_workbench_release_report_manifest(receipt: WorkbenchReleaseReportManifest, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_report_manifest(receipt: WorkbenchReleaseReportManifest) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseReportManifest", "validate_workbench_release_report_manifest", "build_workbench_release_report_manifest", "summarize_workbench_release_report_manifest"]
