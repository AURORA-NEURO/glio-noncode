...
class EditingDesignOutcomeSummaryPlane:
    plane_id: str
    values: dict[str, Any]
    accepted: bool
    content_address: str
...
def build_editing_design_outcome_summary(**kwargs: Any) -> EditingDesignOutcomeSummaryPlane:
    ...
    return EditingDesignOutcomeSummaryPlane(**body, content_address=content_hash(body))

__all__ = ["EditingDesignOutcomeSummaryPlane", "build_editing_design_outcome_summary"]
