...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck:
    FIELDS = CHECK_FIELDS
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck:
        value = _mapping(value, "runtime registry audit check")
        _strict(value, set(cls.FIELDS), "runtime registry audit check")
        return cls(*(value[field] for field in cls.FIELDS))


def address_check(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck):
        raise ValidationError("runtime registry audit check address requires a typed check")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=CHECK_PREFIX)


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit:
    FIELDS = AUDIT_FIELDS

    def __init__(self, registry_address: str, registry_id: str, version: str, boundary: str, check_count: int, passed_count: int, failed_count: int, accepted: bool, checks: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.checks = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck.from_mapping(item) for item in _sequence(checks, "runtime registry audit checks", MAX_CHECKS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit:
        value = _mapping(value, "runtime registry audit")
        _strict(value, set(cls.FIELDS), "runtime registry audit")
        return cls(*(value[field] for field in cls.FIELDS))


def address_audit(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit):
        raise ValidationError("runtime registry audit address requires a typed audit")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=AUDIT_PREFIX)


def _check(check_id: str, passed: bool, detail: str, evidence: Sequence[str]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck(**(body | {"content_address": address_check(provisional)}))


def audit_registry(value: registry_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit(**(body | {"content_address": address_audit(provisional)}))


def verify_audit(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit):
        raise ValidationError("runtime registry audit verification requires a typed audit")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit.from_mapping(value.to_dict())


def audit_from_mapping(value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit:
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit.from_mapping(value)


def audit_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit) -> str:
    return canonical_json(verify_audit(value).to_dict())


def audit_csv(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit) -> str:
...
def render_audit_markdown(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit) -> str:
    value = verify_audit(value)
...
__all__ = ["VERSION", "BOUNDARY", "AUDIT_PREFIX", "CHECK_PREFIX", "CHECK_IDS", "CHECK_FIELDS", "AUDIT_FIELDS", "MAX_CHECKS", "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAuditCheck", "HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryAudit", "address_check", "address_audit", "audit_registry", "verify_audit", "audit_from_mapping", "audit_json", "audit_csv", "render_audit_markdown", "check_schema", "audit_schema", "capabilities"]
