"""Independent workbench query assurance plane.
...
class WorkbenchReleaseWorkbenchQuery:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_query(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchQuery:
    ...
    return WorkbenchReleaseWorkbenchQuery(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_query(receipt: WorkbenchReleaseWorkbenchQuery, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_query(receipt: WorkbenchReleaseWorkbenchQuery) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchQuery", "validate_workbench_release_workbench_query", "build_workbench_release_workbench_query", "summarize_workbench_release_workbench_query"]
