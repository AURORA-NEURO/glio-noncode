"""Resumable addressed transport for exact runtime-registry history-diff archives."""
...
CHUNK_SUFFIX = ".bin"
DEFAULT_TRANSFER_ID = "exact-history-diff-archive-transfer"
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk:
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
    ...
    def __init__(self, transfer_id: str, version: str, boundary: str, archive_address: str, archive_size: int, chunk_size: int, chunk_count: int, chunks: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk], content_address: str, payload: Mapping[int, bytes] | None = None) -> None:
        ...
        self.chunks = tuple(item if isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk.from_mapping(item) for item in _sequence(chunks, "transfer chunks", MAX_CHUNKS))
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress:
...
def address_transfer(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer):
...
def address_progress(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress):
...
def _progress_from_parts(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer, parts: Mapping[int, bytes]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress:
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress(value.content_address, value.archive_address, value.archive_size, value.chunk_count, received, missing, received_bytes, not missing, "pending:progress")
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress(value.content_address, value.archive_address, value.archive_size, value.chunk_count, received, missing, received_bytes, not missing, address_progress(provisional))


class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferAssembler:
    """Idempotent receiver accepting verified chunks in any arrival order."""

    def __init__(self, value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> None:
        if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer):
    ...
    def add_chunk(self, index: int, raw: bytes) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress:
    ...
    def add_chunks(self, parts: Mapping[int, bytes]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress:
    ...
    def progress(self) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress:
...
def _build_from_parts(raw: bytes, archive_value: archive_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive, *, transfer_id: str | None, chunk_size: int) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
    ...
    chunks = tuple(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk(index, index * chunk_size, len(part), address_chunk(part)) for index, part in parts.items())
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer(**body, content_address="pending:transfer", payload=parts)
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer(**body, content_address=address_transfer(provisional), payload=parts)


def build_transfer(value: archive_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive, *, transfer_id: str | None = None, chunk_size: int = DEFAULT_CHUNK_SIZE) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
    if not isinstance(value, archive_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchive):
...
def build_transfer_from_bytes(raw: bytes, *, transfer_id: str | None = None, chunk_size: int = DEFAULT_CHUNK_SIZE) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
...
def transfer_from_mapping(value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
    value = _mapping(value, "history diff archive transfer")
    _strict(value, set(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer.FIELDS), "history diff archive transfer")
    chunks = tuple(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk.from_mapping(item) for item in _sequence(value["chunks"], "transfer chunks", MAX_CHUNKS))
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer(value["transfer_id"], value["version"], value["boundary"], value["archive_address"], value["archive_size"], value["chunk_size"], value["chunk_count"], chunks, value["content_address"])


def _assemble_parts(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer, parts: Mapping[int, bytes]) -> bytes:
...
def assemble_archive_bytes(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer, parts: Mapping[int, bytes] | None = None) -> bytes:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer):
...
def verify_transfer(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer):
...
def _manifest(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> dict[str, Any]:
...
def manifest_document(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> dict[str, Any]:
    return _manifest(verify_transfer(value))


def manifest_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> str:
    return canonical_json(manifest_document(value))


def transfer_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> str:
    return canonical_json(transfer_from_mapping(value.to_dict()).to_dict())


def _expected_names(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer, *, indices: Sequence[int] | None = None) -> set[str]:
...
def _validate_chunk_directory(directory: Path, value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer, *, require_complete: bool) -> tuple[int, ...]:
...
def _write_atomic_directory(destination: Path, value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer, *, parts: Mapping[int, bytes], overwrite: bool) -> Path:
...
def write_transfer(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer, destination: str | Path, *, overwrite: bool = False) -> Path:
    verify_transfer(value)
    return _write_atomic_directory(Path(destination), value, parts=value.payload_bytes(), overwrite=overwrite)


def write_partial_transfer(assembler: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferAssembler, destination: str | Path, *, overwrite: bool = False) -> Path:
    if not isinstance(assembler, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferAssembler):
...
def _read_manifest(directory: Path) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
    ...
    value = transfer_from_mapping({field: document[field] for field in ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer.FIELDS if field != "content_address"} | {"content_address": document["transfer_address"]})
...
def load_transfer(source: str | Path) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
...
def load_partial_transfer(source: str | Path) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferAssembler:
    directory = Path(source)
    if directory.is_symlink() or not directory.is_dir():
        raise ValidationError("transfer input must be a regular directory")
    value = _read_manifest(directory)
...
def verify_transfer_directory(source: str | Path) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer:
    return load_transfer(source)


def verify_partial_transfer(source: str | Path) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress:
...
def transfer_csv(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> str:
    value = verify_transfer(value)
    stream = io.StringIO(newline="")
    writer = csv.DictWriter(stream, fieldnames=ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk.FIELDS, lineterminator="\n")
    writer.writeheader()
    for chunk in value.chunks:
...
def render_transfer_markdown(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer) -> str:
    value = verify_transfer(value)
    lines = ["# Exact Runtime-Registry History-Diff Archive Transfer", "", f"- Transfer: `{value.transfer_id}`", f"- Archive address: `{value.archive_address}`", f"- Bytes: `{value.archive_size}`", f"- Chunks: `{value.chunk_count}` at `{value.chunk_size}` bytes", f"- Address: `{value.content_address}`", "", "| index | offset | bytes | chunk address |", "| ---: | ---: | ---: | --- |"]
    lines.extend(f"| {chunk.index} | {chunk.offset} | {chunk.size} | {chunk.content_address} |" for chunk in value.chunks)
    return "\n".join(lines) + "\n"


def progress_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress):
        raise ValidationError("progress JSON requires a typed progress receipt")
    return canonical_json(value.to_dict())


def progress_csv(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress):
        raise ValidationError("progress CSV requires a typed progress receipt")
    stream = io.StringIO(newline="")
    writer = csv.DictWriter(stream, fieldnames=ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress.FIELDS, lineterminator="\n")
    writer.writeheader()
    writer.writerow(value.to_dict())
    return stream.getvalue()


def render_progress_markdown(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress):
        raise ValidationError("progress Markdown requires a typed progress receipt")
    status = "complete" if value.complete else "partial"
    return "\n".join(("# Exact Runtime-Registry History-Diff Archive Transfer Progress", "", f"- Transfer address: `{value.transfer_address}`", f"- Status: `{status}`", f"- Received: `{len(value.received_indices)}/{value.chunk_count}` chunks", f"- Received bytes: `{value.received_bytes}/{value.archive_size}`", f"- Missing indices: `{', '.join(str(index) for index in value.missing_indices) or 'none'}`", f"- Address: `{value.content_address}`", ""))


def chunk_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Exact runtime-registry history-diff archive transfer chunk", "type": "object", "additionalProperties": False, "required": list(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk.FIELDS), "properties": {"index": {"type": "integer", "minimum": 0, "maximum": MAX_CHUNKS - 1}, "offset": {"type": "integer", "minimum": 0, "maximum": MAX_TRANSFER_BYTES}, "size": {"type": "integer", "minimum": 1, "maximum": MAX_CHUNK_SIZE}, "content_address": {"type": "string", "pattern": "^" + CHUNK_PREFIX + ":"}}}


def transfer_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Exact runtime-registry history-diff archive transfer", "type": "object", "additionalProperties": False, "required": list(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer.FIELDS), "properties": {"transfer_id": {"type": "string"}, "version": {"const": VERSION}, "boundary": {"const": BOUNDARY}, "archive_address": {"type": "string", "pattern": "^" + archive_model.ARCHIVE_PREFIX + ":"}, "archive_size": {"type": "integer", "minimum": 1, "maximum": MAX_TRANSFER_BYTES}, "chunk_size": {"type": "integer", "minimum": MIN_CHUNK_SIZE, "maximum": MAX_CHUNK_SIZE}, "chunk_count": {"type": "integer", "minimum": 1, "maximum": MAX_CHUNKS}, "chunks": {"type": "array", "items": chunk_schema(), "minItems": 1, "maxItems": MAX_CHUNKS}, "content_address": {"type": "string", "pattern": "^" + TRANSFER_PREFIX + ":"}}}
...
def manifest_schema() -> dict[str, Any]:
    ...
    required = [field for field in ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer.FIELDS if field != "content_address"] + ["transfer_address", "manifest_address"]
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Exact runtime-registry history-diff archive transfer manifest", "type": "object", "additionalProperties": False, "required": required, "properties": properties}


def progress_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Exact runtime-registry history-diff archive transfer progress", "type": "object", "additionalProperties": False, "required": list(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress.FIELDS), "properties": {"transfer_address": {"type": "string", "pattern": "^" + TRANSFER_PREFIX + ":"}, "archive_address": {"type": "string", "pattern": "^" + archive_model.ARCHIVE_PREFIX + ":"}, "archive_size": {"type": "integer", "minimum": 1}, "chunk_count": {"type": "integer", "minimum": 1}, "received_indices": {"type": "array", "items": {"type": "integer", "minimum": 0}}, "missing_indices": {"type": "array", "items": {"type": "integer", "minimum": 0}}, "received_bytes": {"type": "integer", "minimum": 0}, "complete": {"type": "boolean"}, "content_address": {"type": "string", "pattern": "^" + PROGRESS_PREFIX + ":"}}}


def capabilities() -> dict[str, Any]:
    return {"public": True, "value_free": True, "version": VERSION, "boundary": BOUNDARY, "transfer_prefix": TRANSFER_PREFIX, "chunk_prefix": CHUNK_PREFIX, "manifest_prefix": MANIFEST_PREFIX, "progress_prefix": PROGRESS_PREFIX, "default_chunk_size": DEFAULT_CHUNK_SIZE, "min_chunk_size": MIN_CHUNK_SIZE, "max_chunk_size": MAX_CHUNK_SIZE, "max_chunks": MAX_CHUNKS, "max_transfer_bytes": MAX_TRANSFER_BYTES, "features": ["verified history-diff archive anchoring", "contiguous byte ranges", "addressed chunk receipts", "out-of-order assembly", "idempotent duplicate chunks", "atomic complete persistence", "atomic partial persistence", "fail-closed nested archive reassembly"], "public_boundary": {"source_paths": False, "source_records": False, "payload_bytes": False, "private_metadata": False}}


__all__ = ["BOUNDARY", "CHUNK_PREFIX", "DEFAULT_CHUNK_SIZE", "DEFAULT_TRANSFER_ID", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransfer", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferAssembler", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferChunk", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferProgress", "MANIFEST_PREFIX", "MAX_CHUNK_SIZE", "MAX_CHUNKS", "MAX_TRANSFER_BYTES", "MIN_CHUNK_SIZE", "PROGRESS_PREFIX", "TRANSFER_DIRECTORY_MANIFEST", "TRANSFER_PREFIX", "VERSION", "address_chunk", "address_progress", "address_transfer", "assemble_archive_bytes", "assemble_transfer_directory", "build_transfer", "build_transfer_from_bytes", "capabilities", "chunk_name", "chunk_schema", "load_partial_transfer", "load_transfer", "manifest_document", "manifest_json", "manifest_schema", "progress_csv", "progress_json", "progress_schema", "render_progress_markdown", "render_transfer_markdown", "transfer_csv", "transfer_from_mapping", "transfer_json", "transfer_schema", "verify_partial_transfer", "verify_transfer", "verify_transfer_directory", "write_partial_transfer", "write_transfer"]
