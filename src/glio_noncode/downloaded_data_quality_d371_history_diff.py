...
from . import downloaded_data_quality_d370_runtime_registry_history as history_model
from ._safe_persistence import _validate_parent, read_text
from .errors import ValidationError
from .serialization import _strict_json_loads, canonical_json, content_hash


# Historical compatibility layers remain readable through ``history_model``,
# but their concatenated version strings eventually exceed the public bound.
# D371 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d371-history-diff-v1"
BOUNDARY = "glio-noncode-d371-history-diff"
