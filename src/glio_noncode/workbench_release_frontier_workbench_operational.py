"""Independent workbench operational assurance plane.
...
class WorkbenchReleaseWorkbenchOperational:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_operational(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchOperational:
    ...
    return WorkbenchReleaseWorkbenchOperational(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_operational(receipt: WorkbenchReleaseWorkbenchOperational, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_operational(receipt: WorkbenchReleaseWorkbenchOperational) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchOperational", "validate_workbench_release_workbench_operational", "build_workbench_release_workbench_operational", "summarize_workbench_release_workbench_operational"]
