"""Independent workbench bundle assurance plane.
...
class WorkbenchReleaseWorkbenchBundle:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_bundle(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchBundle:
    ...
    return WorkbenchReleaseWorkbenchBundle(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_bundle(receipt: WorkbenchReleaseWorkbenchBundle, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_bundle(receipt: WorkbenchReleaseWorkbenchBundle) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchBundle", "validate_workbench_release_workbench_bundle", "build_workbench_release_workbench_bundle", "summarize_workbench_release_workbench_bundle"]
