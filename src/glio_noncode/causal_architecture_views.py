"""Sanitized D11 case and operation views."""
...
def causal_architecture_case_views(
...
def causal_architecture_operation_views(
    runtime: CausalArchitectureRuntime,
) -> tuple[dict[str, Any], ...]:
    cases = causal_architecture_case_views(runtime)
    return tuple(
        {
...
__all__ = ["causal_architecture_case_views", "causal_architecture_operation_views"]
