"""Source-to-receipt lineage for Domain 07 chromatin evidence."""
...
from .chromatin_frontier_public_data import ChromatinFrontierFixture
from .serialization import content_hash, jsonable, require_non_empty


@dataclass(frozen=True, slots=True)
class ChromatinFrontierLineageEdge:
    edge_id: str
    record_id: str
    ...
    def __post_init__(self) -> None:
        ...
        if not self.source_ids:
            raise ValueError("chromatin frontier lineage edge requires sources")
...
@dataclass(frozen=True, slots=True)
class ChromatinFrontierLineageReport:
    fixture_id: str
    fixture_address: str
    edges: tuple[ChromatinFrontierLineageEdge, ...]
    source_ids: tuple[str, ...]
    content_address: str
...
def build_chromatin_frontier_lineage(
    ...
    edges: list[ChromatinFrontierLineageEdge] = []
    for receipt in evaluation.receipts:
        ...
        body = {
            ...
            "transformation": "parse public aggregate chromatin rows, apply declared adapter, emit sanitized receipt",
        }
        address = content_hash(body)
        edges.append(
            ChromatinFrontierLineageEdge(
                "edge:" + address.split(":", 1)[1][:24],
                **body,
    ...
    return ChromatinFrontierLineageReport(
        fixture.fixture_id,
...
def verify_chromatin_frontier_lineage(
