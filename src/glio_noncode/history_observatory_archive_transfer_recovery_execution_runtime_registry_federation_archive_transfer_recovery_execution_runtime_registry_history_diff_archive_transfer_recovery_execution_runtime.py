...
DEFAULT_RUNTIME_ID = "runtime-registry-history-diff-archive-transfer-recovery-execution-runtime"
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> "HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage":
        value = _mapping(value, "runtime stage")
        _strict(value, set(cls.FIELDS), "runtime stage")
        return cls(*(value[field] for field in cls.FIELDS))


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> "HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact":
        value = _mapping(value, "runtime artifact")
        _strict(value, set(cls.FIELDS), "runtime artifact")
        return cls(*(value[field] for field in cls.FIELDS))


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest:
    """The exact-file manifest for a persisted execution runtime."""

    FIELDS = MANIFEST_FIELDS

    def __init__(self, runtime_id: str, version: str, boundary: str, files: Sequence[str], artifacts: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact], runtime_address: str, manifest_address: str) -> None:
        ...
        self.artifacts = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact.from_mapping(item) for item in _sequence(artifacts, "runtime manifest artifacts", len(ARTIFACT_FILES)))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> "HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest":
        value = _mapping(value, "runtime manifest")
        _strict(value, set(cls.FIELDS), "runtime manifest")
        return cls(value["runtime_id"], value["version"], value["boundary"], value["files"], tuple(HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact.from_mapping(item) for item in _sequence(value["artifacts"], "runtime manifest artifacts", len(ARTIFACT_FILES))), value["runtime_address"], value["manifest_address"])


class HistoryDiffArchiveTransferRecoveryExecutionRuntime:
    """A durable, value-free handoff for execution and its inspections."""

    FIELDS = RUNTIME_FIELDS

    def __init__(self, runtime_id: str, version: str, boundary: str, execution_id: str, execution_address: str, execution_audit_address: str, query_address: str, query_audit_address: str, stage_count: int, stages: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage], state: str, accepted: bool, content_address: str, *, execution: Any = None, execution_audit: Any = None, query: Any = None, query_audit: Any = None) -> None:
        ...
        self.stages = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage.from_mapping(item) for item in _sequence(stages, "runtime stages", len(STAGES)))
        if state not in STATES:
    ...
    def _validate(self) -> None:
        ...
        if self.execution is not None:
            if not isinstance(self.execution, execution_model.HistoryDiffArchiveTransferRecoveryExecution) or self.execution.execution_id != self.execution_id or self.execution.content_address != self.execution_address:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> "HistoryDiffArchiveTransferRecoveryExecutionRuntime":
        value = _mapping(value, "recovery execution runtime")
        _strict(value, set(cls.FIELDS), "recovery execution runtime")
        return cls(value["runtime_id"], value["version"], value["boundary"], value["execution_id"], value["execution_address"], value["execution_audit_address"], value["query_address"], value["query_audit_address"], value["stage_count"], tuple(HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage.from_mapping(item) for item in _sequence(value["stages"], "runtime stages", len(STAGES))), value["state"], value["accepted"], value["content_address"])


def address_stage(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage):
...
def address_artifact(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact):
...
def address_manifest(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest):
...
def address_runtime(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntime):
...
def _stage(ordinal: int, stage: str, accepted: bool, address: str, detail: str) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage:
    pending = HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage(ordinal, stage, "ready" if accepted else "blocked", accepted, address, detail, "pending:runtime-stage")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage(ordinal, stage, pending.state, accepted, address, detail, address_stage(pending))


def _build_stages(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime, execution_audit: Any, query: Any, query_audit: Any) -> tuple[HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage, ...]:
    return (
...
def build_runtime(execution: execution_model.HistoryDiffArchiveTransferRecoveryExecution, *, runtime_id: str = DEFAULT_RUNTIME_ID, resources: Sequence[str] | None = None, status: str = "", index: int = -1, text: str = "", offset: int = 0, limit: int | None = None) -> HistoryDiffArchiveTransferRecoveryExecutionRuntime:
    from . import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_audit as execution_audit_model
    from . import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_query as query_model
    from . import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_query_audit as query_audit_model

    execution = execution_model.execution_from_mapping(execution.to_dict()) if isinstance(execution, execution_model.HistoryDiffArchiveTransferRecoveryExecution) else execution_model.execution_from_mapping(execution)
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntime(**body, stages=(_stage(1, "execution", True, execution.content_address, "execution receipt is structurally valid"), _stage(2, "audit", execution_audit.passed, execution_audit.content_address, "independent execution audit completed"), _stage(3, "query", True, query.content_address, "bounded execution query completed"), _stage(4, "query-audit", query_audit.passed, query_audit.content_address, "independent execution query audit completed"), _stage(5, "complete", accepted, query_audit.content_address, "runtime handoff is ready" if accepted else "runtime handoff is blocked by an audit result")), content_address="pending:runtime", execution=execution, execution_audit=execution_audit, query=query, query_audit=query_audit)
    stages = _build_stages(provisional, execution_audit, query, query_audit)
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntime(**body, stages=stages, content_address="pending:runtime", execution=execution, execution_audit=execution_audit, query=query, query_audit=query_audit)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntime(**body, stages=stages, content_address=address_runtime(provisional), execution=execution, execution_audit=execution_audit, query=query, query_audit=query_audit)


def verify_runtime(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime) -> HistoryDiffArchiveTransferRecoveryExecutionRuntime:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntime):
...
def runtime_from_mapping(value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntime:
    return HistoryDiffArchiveTransferRecoveryExecutionRuntime.from_mapping(value)


def runtime_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime) -> str:
    return canonical_json(runtime_from_mapping(value.to_dict()).to_dict())


def runtime_csv(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime) -> str:
...
def render_runtime_markdown(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime) -> str:
    value = verify_runtime(value)
...
def _documents(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime) -> dict[str, bytes]:
...
def _build_manifest(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest:
    documents = _documents(value)
    receipts = tuple(HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact(index, name, len(documents[name]), hash_bytes(documents[name], prefix=ARTIFACT_PREFIX), "pending:runtime-artifact") for index, name in enumerate(ARTIFACT_FILES, 1))
    receipts = tuple(HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact(item.ordinal, item.name, item.size, item.hash, address_artifact(item)) for item in receipts)
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest(**body, manifest_address="pending:runtime-manifest")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest(**body, manifest_address=address_manifest(provisional))


def manifest_document(value: HistoryDiffArchiveTransferRecoveryExecutionRuntime) -> dict[str, Any]:
    return _build_manifest(verify_runtime(value)).to_dict()


def manifest_schema() -> dict[str, Any]:
    artifact = {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "History-diff archive transfer recovery execution runtime artifact", "type": "object", "additionalProperties": False, "required": list(ARTIFACT_FIELDS), "properties": {"ordinal": {"type": "integer", "minimum": 1}, "name": {"type": "string", "enum": list(ARTIFACT_FILES)}, "size": {"type": "integer", "minimum": 1}, "hash": {"type": "string", "pattern": "^" + ARTIFACT_PREFIX + ":"}, "content_address": {"type": "string", "pattern": "^" + ARTIFACT_PREFIX + ":"}}}
...
def _compose(runtime: HistoryDiffArchiveTransferRecoveryExecutionRuntime, execution: Any, execution_audit: Any, query: Any, query_audit: Any) -> HistoryDiffArchiveTransferRecoveryExecutionRuntime:
    body = runtime.to_dict()
    return HistoryDiffArchiveTransferRecoveryExecutionRuntime(**body, execution=execution, execution_audit=execution_audit, query=query, query_audit=query_audit)


def load_runtime(destination: str | Path) -> HistoryDiffArchiveTransferRecoveryExecutionRuntime:
    from . import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_audit as execution_audit_model
    from . import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_query as query_model
    from . import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_query_audit as query_audit_model
    ...
    manifest = HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest.from_mapping(manifest_raw)
    ...
    for receipt in manifest.artifacts:
        ...
        expected = HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact(receipt.ordinal, receipt.name, len(raw), hash_bytes(raw, prefix=ARTIFACT_PREFIX), "pending:runtime-artifact")
...
def run_runtime(source: str | Path | HistoryDiffArchiveTransferRecoveryExecutionRuntime | execution_model.HistoryDiffArchiveTransferRecoveryExecution, *, runtime_id: str = DEFAULT_RUNTIME_ID, resources: Sequence[str] | None = None, status: str = "", index: int = -1, text: str = "", offset: int = 0, limit: int | None = None, destination: str | Path | None = None, overwrite: bool = False) -> HistoryDiffArchiveTransferRecoveryExecutionRuntime:
    ...
    elif isinstance(source, HistoryDiffArchiveTransferRecoveryExecutionRuntime):
...
__all__ = ["ARTIFACT_FILES", "ARTIFACT_FIELDS", "ARTIFACT_PREFIX", "BOUNDARY", "DEFAULT_RUNTIME_ID", "FILES", "MANIFEST_ARTIFACT_FIELDS", "MANIFEST_FIELDS", "MANIFEST_PREFIX", "MAX_RUNTIME_BYTES", "RUNTIME_FIELDS", "RUNTIME_PREFIX", "STAGE_FIELDS", "STAGE_PREFIX", "STAGES", "STATES", "HistoryDiffArchiveTransferRecoveryExecutionRuntime", "HistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact", "HistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest", "HistoryDiffArchiveTransferRecoveryExecutionRuntimeStage", "address_artifact", "address_manifest", "address_runtime", "address_stage", "build_runtime", "capabilities", "load_runtime", "manifest_document", "manifest_schema", "persist_runtime", "render_runtime_markdown", "run_runtime", "runtime_csv", "runtime_from_mapping", "runtime_json", "runtime_schema", "stage_schema", "verify_runtime", "VERSION"]
