"""Independent accessibility remediation assurance plane.
...
class WorkbenchReleaseAccessibilityRemediation:
    count: int
    accepted: bool
...
def build_workbench_release_accessibility_remediation(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseAccessibilityRemediation:
    ...
    return WorkbenchReleaseAccessibilityRemediation(**body, content_address=content_hash(body))


def validate_workbench_release_accessibility_remediation(receipt: WorkbenchReleaseAccessibilityRemediation, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_accessibility_remediation(receipt: WorkbenchReleaseAccessibilityRemediation) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseAccessibilityRemediation", "validate_workbench_release_accessibility_remediation", "build_workbench_release_accessibility_remediation", "summarize_workbench_release_accessibility_remediation"]
