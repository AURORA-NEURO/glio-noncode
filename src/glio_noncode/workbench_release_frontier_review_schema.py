"""Independent review schema assurance plane.
...
class WorkbenchReleaseReviewSchema:
    count: int
    accepted: bool
...
def build_workbench_release_review_schema(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseReviewSchema:
    ...
    return WorkbenchReleaseReviewSchema(**body, content_address=content_hash(body))


def validate_workbench_release_review_schema(receipt: WorkbenchReleaseReviewSchema, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_review_schema(receipt: WorkbenchReleaseReviewSchema) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseReviewSchema", "validate_workbench_release_review_schema", "build_workbench_release_review_schema", "summarize_workbench_release_review_schema"]
