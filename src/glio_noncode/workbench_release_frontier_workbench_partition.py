"""Independent workbench partition assurance plane.
...
class WorkbenchReleaseWorkbenchPartition:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_partition(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchPartition:
    ...
    return WorkbenchReleaseWorkbenchPartition(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_partition(receipt: WorkbenchReleaseWorkbenchPartition, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_partition(receipt: WorkbenchReleaseWorkbenchPartition) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchPartition", "validate_workbench_release_workbench_partition", "build_workbench_release_workbench_partition", "summarize_workbench_release_workbench_partition"]
