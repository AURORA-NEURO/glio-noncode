"""Typed contracts for portable packet-package handoff catalog diff policy review packets."""
...
VERSION = "downloaded-data-review-packet-diff-policy-release-certificate-bundle-diff-policy-package-catalog-diff-policy-review-packet-v1"
BOUNDARY = "public_downloaded_data_review_packet_diff_policy_release_certificate_bundle_diff_policy_package_catalog_diff_policy_review_packet"
PACKAGE_PREFIX = "glio-noncode-download-packet-catalog-diff-policy-review"
