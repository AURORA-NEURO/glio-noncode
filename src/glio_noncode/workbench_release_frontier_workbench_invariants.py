"""Independent workbench invariants assurance plane.
...
class WorkbenchReleaseWorkbenchInvariants:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_invariants(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchInvariants:
    ...
    return WorkbenchReleaseWorkbenchInvariants(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_invariants(receipt: WorkbenchReleaseWorkbenchInvariants, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_invariants(receipt: WorkbenchReleaseWorkbenchInvariants) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchInvariants", "validate_workbench_release_workbench_invariants", "build_workbench_release_workbench_invariants", "summarize_workbench_release_workbench_invariants"]
