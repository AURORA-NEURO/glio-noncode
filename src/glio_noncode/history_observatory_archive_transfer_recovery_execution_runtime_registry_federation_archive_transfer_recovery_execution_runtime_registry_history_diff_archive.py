...
def _embedded_diff(value: diff_model.RecoveryExecutionRuntimeRegistryHistoryDiff) -> dict[str, bytes]:
    checked = diff_model.verify_diff(value)
    items = diff_model.RecoveryExecutionRuntimeRegistryHistoryDiffItems(checked.items, diff_model.address_items(checked.items))
    documents = {
...
class RecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    ...
    def __init__(
        ...
        diff: diff_model.RecoveryExecutionRuntimeRegistryHistoryDiff | None = None,
    ) -> None:
    ...
    @property
    def diff(self) -> diff_model.RecoveryExecutionRuntimeRegistryHistoryDiff | None:
        return self._diff
...
def build_archive(value: diff_model.RecoveryExecutionRuntimeRegistryHistoryDiff, *, archive_id: str = DEFAULT_ARCHIVE_ID) -> RecoveryExecutionRuntimeRegistryHistoryDiffArchive:
    checked = diff_model.verify_diff(value)
