"""Deep review assignment receipt for workbench release review.
...
class WorkbenchReleaseReviewAssignment:
...
def build_workbench_release_review_assignment(values: Iterable[Any] = (), *, require_non_empty: bool = True) -> WorkbenchReleaseReviewAssignment:
    rows = tuple(
        {
            "sequence": index,
    ...
    return WorkbenchReleaseReviewAssignment(**body, content_address=content_hash(body))


def validate_workbench_release_review_assignment(receipt: WorkbenchReleaseReviewAssignment) -> bool:
...
__all__ = ["WorkbenchReleaseReviewAssignment", "build_workbench_release_review_assignment", "validate_workbench_release_review_assignment"]
