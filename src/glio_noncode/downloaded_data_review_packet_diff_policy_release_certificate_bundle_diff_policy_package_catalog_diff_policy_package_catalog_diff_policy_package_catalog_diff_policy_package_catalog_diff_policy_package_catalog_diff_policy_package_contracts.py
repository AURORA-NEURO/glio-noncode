"""Typed contracts for portable review-packet catalog diff policy review packets."""
...
VERSION = "downloaded-data-review-packet-diff-policy-release-certificate-bundle-diff-policy-package-catalog-diff-policy-review-catalog-diff-policy-review-packet-v1"
BOUNDARY = "public_downloaded_data_review_packet_diff_policy_release_certificate_bundle_diff_policy_package_catalog_diff_policy_review_catalog_diff_policy_review_packet"
PACKAGE_PREFIX = "glio-noncode-download-packet-catalog-diff-policy-review-catalog-diff-policy-review"
...
class DownloadedDataReviewPacketDiffPolicyReleaseCertificateBundleDiffPolicyPackageCatalogDiffPolicyReviewPacketManifest:
    ...
    def __post_init__(self) -> None:
        ...
        _address(self.diff_address, "catalog diff policy packet diff address")
        _address(self.policy_address, "catalog diff policy packet policy address")
        _address(self.audit_address, "catalog diff policy packet audit address")
