"""Deterministic ZIP transport for comparison-query history observatories.

The history observatory has an exact five-file directory handoff. This module
adds a single-file transport boundary while retaining canonical projections,
content addresses, nested identity, and value-free public metadata. ZIP member
order, timestamps, compression, permissions, and comments are fixed so equal
observatories produce equal archive bytes.
"""
...
PAYLOAD_PREFIX = "history-observatory/"
...
DEFAULT_ARCHIVE_ID = "comparison-query-snapshot-registry-history-observatory-archive"
...
def _observatory_payload(value: observatory_model.DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatory) -> dict[str, bytes]:
    value = observatory_model.observatory_from_mapping(value.to_dict())
    members = observatory_model.DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryMembers(value.members, observatory_model.address_members(value.members))
    transitions = observatory_model.DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryTransitions(value.transitions, observatory_model.address_transitions(value.transitions))
    documents = {
...
class DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchiveArtifact:
...
class DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive:
    ...
    def __init__(self, archive_id: str, version: str, boundary: str, observatory_id: str, observatory_address: str, artifact_count: int, files: Sequence[str], artifacts: Sequence[Any], archive_size: int, content_address: str, payload: Mapping[str, bytes] | None = None, observatory: observatory_model.DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatory | None = None) -> None:
        ...
        self.artifacts = tuple(item if isinstance(item, DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchiveArtifact) else DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchiveArtifact.from_mapping(item) for item in _sequence(artifacts, "archive artifacts", len(observatory_model.FILES)))
...
def address_archive(value: DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive) -> str:
    if not isinstance(value, DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive):
...
def build_archive(value: observatory_model.DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatory, *, archive_id: str = DEFAULT_ARCHIVE_ID):
    ...
    artifacts = tuple(DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchiveArtifact(index, name, len(payload[name]), hash_bytes(payload[name], prefix=ARTIFACT_PREFIX)) for index, name in enumerate(ARCHIVE_PAYLOAD_FILES))
    ...
    provisional = DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive(**body, content_address="pending:archive", payload=payload, observatory=observatory)
    candidate = DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive(**body, content_address=address_archive(provisional), payload=payload, observatory=observatory)
    actual_size = len(_zip_bytes_unchecked(candidate))
    final = DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive(**(body | {"archive_size": actual_size}), content_address=candidate.content_address, payload=payload, observatory=observatory)
    if len(_zip_bytes_unchecked(final)) != actual_size:
        raise ValidationError("archive size did not converge")
    return final
...
def archive_from_mapping(value: Mapping[str, Any]):
    value = _mapping(value, "history observatory archive")
    _strict(value, set(DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive.FIELDS), "history observatory archive")
    artifacts = tuple(DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchiveArtifact.from_mapping(item) for item in _sequence(value["artifacts"], "archive artifacts", len(observatory_model.FILES)))
    return verify_archive(DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive(value["archive_id"], value["version"], value["boundary"], value["observatory_id"], value["observatory_address"], value["artifact_count"], _sequence(value["files"], "archive files", len(observatory_model.FILES)), artifacts, value["archive_size"], value["content_address"]))
...
def render_archive_markdown(value) -> str:
    value = verify_archive(value)
    lines = ["# Comparison-query history observatory archive", "", f"- Archive: {value.archive_id}", f"- Observatory: {value.observatory_id}", f"- Observatory address: {value.observatory_address}", f"- ZIP bytes: {value.archive_size}", f"- Address: {value.content_address}", "", "| index | member | bytes | receipt |", "| ---: | --- | ---: | --- |"]
    lines.extend(f"| {item.index} | {item.name} | {item.size} | {item.hash} |" for item in value.artifacts)
    return "\n".join(lines) + "\n"


def artifact_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Comparison-query history observatory archive artifact", "type": "object", "additionalProperties": False, "required": list(DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchiveArtifact.FIELDS), "properties": {"index": {"type": "integer", "minimum": 0}, "name": {"type": "string", "enum": list(ARCHIVE_PAYLOAD_FILES)}, "size": {"type": "integer", "minimum": 1}, "hash": {"type": "string", "pattern": "^" + ARTIFACT_PREFIX + ":"}}}
...
def manifest_schema() -> dict[str, Any]:
    ...
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Comparison-query history observatory archive manifest", "type": "object", "additionalProperties": False, "required": list(fields), "properties": fields}
...
def archive_schema() -> dict[str, Any]:
    ...
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Comparison-query history observatory archive", "type": "object", "additionalProperties": False, "required": list(DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive.FIELDS), "properties": fields}


def capabilities() -> dict[str, Any]:
    return {"public": True, "value_free": True, "version": VERSION, "boundary": BOUNDARY, "archive_prefix": ARCHIVE_PREFIX, "manifest_prefix": MANIFEST_PREFIX, "artifact_prefix": ARTIFACT_PREFIX, "files": list(FILES), "payload_files": list(ARCHIVE_PAYLOAD_FILES), "zip_epoch": ZIP_EPOCH, "max_archive_bytes": MAX_ARCHIVE_BYTES, "features": ["deterministic ZIP bytes", "exact five-file observatory embedding", "canonical manifest replay", "byte receipt verification", "atomic file replacement", "path traversal and encryption rejection", "JSON CSV and Markdown projections"], "public_boundary": {"source_paths": False, "source_records": False, "private_metadata": False}}


__all__ = ["ARCHIVE_MANIFEST_NAME", "ARCHIVE_PAYLOAD_FILES", "ARCHIVE_PREFIX", "ARTIFACT_PREFIX", "BOUNDARY", "DEFAULT_ARCHIVE_ID", "FILES", "MANIFEST_PREFIX", "MAX_ARCHIVE_BYTES", "PAYLOAD_PREFIX", "DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchive", "DownloadedDataProfileContractCompatibilityRemediationResolutionHistoryDiffPolicyPackageRegistryObservatoryArchiveRuntimeQuerySnapshotDiffQuerySnapshotDiffQuerySnapshotRegistryHistoryObservatoryArchiveArtifact", "VERSION", "address_archive", "archive_bytes", "archive_csv", "archive_from_mapping", "archive_json", "archive_schema", "artifact_schema", "build_archive", "build_archive_from_directory", "capabilities", "load_archive", "load_archive_bytes", "manifest_document", "manifest_schema", "render_archive_markdown", "verify_archive", "verify_archive_file", "write_archive"]
