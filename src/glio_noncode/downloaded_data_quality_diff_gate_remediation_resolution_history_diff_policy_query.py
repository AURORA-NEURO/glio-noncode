...
VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-policy-query-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_query"
QUERY_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff-policy-query"
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow:
    FIELDS = ROW_FIELDS
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow:
        value = _mapping(value, "history diff policy query row")
        _strict(value, set(cls.FIELDS), "history diff policy query row")
        return cls(*(value[field] for field in cls.FIELDS))


def address_row(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery:
    ...
    def __init__(self, evaluation_address: str, version: str, boundary: str, resources: Sequence[str], resource: str, rule_id: str, passed: bool | None, text: str, offset: int, limit: int, total_count: int, matched_count: int, returned_count: int, next_offset: int, truncated: bool, rows: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.rows = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow.from_mapping(item) for item in _sequence(rows, "history diff policy query rows", MAX_LIMIT))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery:
        value = _mapping(value, "history diff policy query")
        _strict(value, set(cls.FIELDS), "history diff policy query")
        return cls(*(value[field] for field in cls.FIELDS))


def address_query(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery):
        raise ValidationError("history diff policy query address requires a typed query")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=QUERY_PREFIX)


def _summary_row(value: policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyEvaluation) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow(**(body | {"content_address": address_row(provisional)}))


def _rule_row(value: policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRule, ordinal: int) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow:
...
def _matches(row: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow, query: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery) -> bool:
...
def query_evaluation(value: policy_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyEvaluation, *, resources: Sequence[str] = RESOURCES, resource: str = "", rule_id: str = "", passed: bool | None = None, text: str = "", offset: int = 0, limit: int = MAX_LIMIT) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery(value.content_address, VERSION, BOUNDARY, resources, resource, rule_id, passed, text, offset, limit, 0, 0, 0, offset, False, (), QUERY_PREFIX + ":pending")
    ...
    provisional_result = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery(**(body | {"content_address": address_query(provisional_result)}))


def _readdress(row: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow, ordinal: int) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow:
    body = row.to_dict() | {"ordinal": ordinal, "content_address": ROW_PREFIX + ":pending"}
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow(**(body | {"content_address": address_row(provisional)}))


def query_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery.from_mapping(value)


def query_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery) -> str:
    return canonical_json(query_from_mapping(value.to_dict()).to_dict())


def query_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery) -> str:
...
def render_query_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery) -> str:
    value = query_from_mapping(value.to_dict())
...
def row_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy query row", "type": "object", "additionalProperties": False, "required": list(ROW_FIELDS), "properties": {"ordinal": {"type": "integer", "minimum": 1}, "resource": {"enum": list(RESOURCES)}, "identity": {"type": "string"}, "rule_id": {"type": "string"}, "passed": {"type": "boolean"}, "observed": {"type": "string"}, "limit": {"type": "string"}, "detail": {"type": "string"}, "content_address": {"type": "string"}}}


def query_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy query", "type": "object", "additionalProperties": False, "required": list(QUERY_FIELDS), "properties": {"evaluation_address": {"type": "string"}, "version": {"const": VERSION}, "boundary": {"const": BOUNDARY}, "resources": {"type": "array", "items": {"enum": list(RESOURCES)}}, "resource": {"type": "string"}, "rule_id": {"type": "string"}, "passed": {"type": ["boolean", "null"]}, "text": {"type": "string"}, "offset": {"type": "integer", "minimum": 0}, "limit": {"type": "integer", "minimum": 1}, "total_count": {"type": "integer", "minimum": 0}, "matched_count": {"type": "integer", "minimum": 0}, "returned_count": {"type": "integer", "minimum": 0}, "next_offset": {"type": "integer", "minimum": 0}, "truncated": {"type": "boolean"}, "rows": {"type": "array", "items": row_schema(), "maxItems": MAX_LIMIT}, "content_address": {"type": "string"}}}
...
__all__ = ["BOUNDARY", "MAX_LIMIT", "MAX_TOTAL_COUNT", "QUERY_FIELDS", "QUERY_PREFIX", "RESOURCES", "ROW_FIELDS", "ROW_PREFIX", "VERSION", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQuery", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyQueryRow", "address_query", "address_row", "capabilities", "query_csv", "query_evaluation", "query_from_mapping", "query_json", "query_schema", "render_query_markdown", "row_schema"]
