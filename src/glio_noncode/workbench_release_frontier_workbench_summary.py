"""Independent workbench summary assurance plane.
...
class WorkbenchReleaseWorkbenchSummary:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_summary(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchSummary:
    ...
    return WorkbenchReleaseWorkbenchSummary(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_summary(receipt: WorkbenchReleaseWorkbenchSummary, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_summary(receipt: WorkbenchReleaseWorkbenchSummary) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchSummary", "validate_workbench_release_workbench_summary", "build_workbench_release_workbench_summary", "summarize_workbench_release_workbench_summary"]
