...
VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-policy-package-registry-history-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_package_registry_history"
HISTORY_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff-policy-package-registry-history"
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry:
        value = _mapping(value, "registry history entry")
        _strict(value, set(cls.FIELDS), "registry history entry")
        return cls(*(value[field] for field in cls.FIELDS))


def address_entry(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry):
...
def entry_from_registry(value: registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistry, ordinal: int, transition: str, previous_registry_address: str) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry:
    if not isinstance(value, registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistry):
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry(**(body | {"content_address": address_entry(provisional)}))


class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntries:
    FIELDS = ENTRIES_FIELDS

    def __init__(self, entries: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry | Mapping[str, Any]], content_address: str) -> None:
        self.entries = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry.from_mapping(item) for item in _sequence(entries, "registry history entries", MAX_ENTRIES))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntries:
...
def address_entries(value: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry]) -> str:
    typed = tuple(value)
    if any(not isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry) for item in typed):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest:
        value = _mapping(value, "registry history manifest")
        _strict(value, set(cls.FIELDS), "registry history manifest")
        return cls(*(value[field] for field in cls.FIELDS))


def address_manifest(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary:
        value = _mapping(value, "registry history summary")
        _strict(value, set(cls.FIELDS), "registry history summary")
        return cls(*(value[field] for field in cls.FIELDS))


def address_summary(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory:
    FIELDS = HISTORY_FIELDS

    def __init__(self, history_id: str, registry_id: str, version: str, boundary: str, entry_count: int, latest_registry_address: str, latest_entry_count: int, latest_accepted_count: int, latest_release_ready_count: int, initial_count: int, improved_count: int, regressed_count: int, unchanged_count: int, changed_count: int, state: str, decision: str, accepted: bool, release_ready: bool, manifest: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest | Mapping[str, Any], summary: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary | Mapping[str, Any], entries: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.manifest = manifest if isinstance(manifest, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest.from_mapping(manifest)
        self.summary = summary if isinstance(summary, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary.from_mapping(summary)
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory:
        value = _mapping(value, "registry history")
        _strict(value, set(cls.FIELDS), "registry history")
        return cls(*(value[field] for field in cls.FIELDS))


def address_history(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory):
...
def build_history(registries: Sequence[registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistry], *, history_id: str = DEFAULT_HISTORY_ID) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory:
    registries = _sequence(registries, "registry history registries", MAX_ENTRIES)
    if any(not isinstance(item, registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistry) for item in registries):
    ...
    summary_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary(**summary_body)
    summary = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary(**(summary_body | {"content_address": address_summary(summary_provisional)}))
    ...
    manifest_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest(**manifest_body)
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest(**(manifest_body | {"content_address": address_manifest(manifest_provisional)}))
    ...
    provisional_history = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory(**(body | {"content_address": address_history(provisional_history)}))


def history_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory.from_mapping(value)


def history_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory) -> str:
    return canonical_json(history_from_mapping(value.to_dict()).to_dict())


def history_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory) -> str:
...
def render_history_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory) -> str:
    value = history_from_mapping(value.to_dict())
...
def entries_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntries) -> str:
    return canonical_json(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntries.from_mapping(value.to_dict()).to_dict())


def summary_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary) -> str:
    return canonical_json(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary.from_mapping(value.to_dict()).to_dict())
...
def _write(path: Path, value: Any) -> None:
    atomic_write_bytes(
        ...
        field="registry history document",
    )


def persist_history(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory, destination: str | Path, *, overwrite: bool = False) -> Path:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory):
    ...
    try:
        entries = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntries(value.entries, address_entries(value.entries))
...
def _read_json(path: Path) -> Mapping[str, Any]:
    try:
        value = _strict_json_loads(read_text(path, field="registry history artifact"))
...
def _read_canonical(path: Path, value: Mapping[str, Any]) -> None:
    try:
        actual = read_text(path, field="registry history artifact")
...
def load_history(destination: str | Path) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory:
    destination = Path(destination)
    try:
        _validate_parent(destination.parent, "registry history input")
        if destination.is_symlink() or not destination.is_dir():
            raise ValidationError("registry history destination must be a directory")
    except ValidationError:
        raise
    except OSError as error:
        raise ValidationError("registry history input could not be inspected") from error
    ...
    entries = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntries.from_mapping(raw["entries.json"])
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest.from_mapping(raw["manifest.json"])
    summary = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary.from_mapping(raw["summary.json"])
...
def run_history(registries: Sequence[registry_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistry], *, history_id: str = DEFAULT_HISTORY_ID, destination: str | Path | None = None, overwrite: bool = False) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory:
...
__all__ = ["BOUNDARY", "DECISIONS", "DEFAULT_HISTORY_ID", "ENTRIES_FIELDS", "ENTRIES_PREFIX", "ENTRY_FIELDS", "ENTRY_PREFIX", "FILES", "HISTORY_FIELDS", "HISTORY_PREFIX", "MANIFEST_ARTIFACT_FILES", "MANIFEST_FIELDS", "MAX_ENTRIES", "STATES", "SUMMARY_FIELDS", "SUMMARY_PREFIX", "TRANSITIONS", "VERSION", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntries", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryManifest", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistorySummary", "address_entries", "address_entry", "address_history", "address_manifest", "address_summary", "build_history", "capabilities", "entries_json", "entries_schema", "entry_from_registry", "entry_schema", "history_csv", "history_from_mapping", "history_json", "history_schema", "load_history", "manifest_schema", "persist_history", "render_history_markdown", "run_history", "summary_json", "summary_schema"]
