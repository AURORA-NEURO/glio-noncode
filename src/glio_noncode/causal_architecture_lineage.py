"""D11 source, operation, and case lineage."""
...
def build_causal_architecture_lineage(fixture: CausalArchitectureFixture) -> dict[str, Any]:
    ...
    return body | {"content_address": addressed(body, "causal-lineage")}


def causal_architecture_lineage_gaps(fixture: CausalArchitectureFixture) -> tuple[str, ...]:
...
__all__ = ["build_causal_architecture_lineage", "causal_architecture_lineage_gaps"]
