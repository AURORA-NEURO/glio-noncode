...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow:
    FIELDS = ROW_FIELDS
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow:
        value = _mapping(value, "runtime registry query row")
        _strict(value, set(cls.FIELDS), "runtime registry query row")
        return cls(*(value[field] for field in cls.FIELDS))


def address_row(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow):
...
def _row(resource: str, key: str, value: Any, address: str, state: str, accepted: bool, ordinal: int) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow:
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow(**body)
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow(**(body | {"row_address": address_row(provisional)}))


def _all_rows(value: registry_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) -> tuple[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow, ...]:
    value = registry_model.verify_registry(value)
    rows: list[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow] = []
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery:
    FIELDS = QUERY_FIELDS

    def __init__(self, query_id: str, registry_id: str, registry_address: str, resources: Sequence[str], state_filter: str, key_filter: str, text_filter: str, offset: int, limit: int, total_count: int, returned_count: int, truncated: bool, rows: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.rows = tuple(item if isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryRow.from_mapping(item) for item in _sequence(rows, "runtime registry query rows", MAX_LIMIT))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery:
        value = _mapping(value, "runtime registry query")
        _strict(value, set(cls.FIELDS), "runtime registry query")
        return cls(*(value[field] for field in cls.FIELDS))


def address_query(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery):
        raise ValidationError("runtime registry query address requires a typed query")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=QUERY_PREFIX)


def query_registry(value: registry_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry, *, resources: Sequence[str] | None = None, state: str = "", key: str = "", text: str = "", offset: int = 0, limit: int = MAX_LIMIT, query_id: str = DEFAULT_QUERY_ID) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery:
    value = registry_model.verify_registry(value)
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery(**body)
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery(**(body | {"content_address": address_query(provisional)}))


def query_from_mapping(value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery:
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery.from_mapping(value)


def query_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery) -> str:
    return canonical_json(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery.from_mapping(value.to_dict()).to_dict())


def query_csv(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery) -> str:
    value = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery.from_mapping(value.to_dict())
    output = io.StringIO()
...
def render_query_markdown(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery) -> str:
    value = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery.from_mapping(value.to_dict())
