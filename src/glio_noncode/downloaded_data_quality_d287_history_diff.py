...
from . import downloaded_data_quality_d286_runtime_registry_history as history_model
...
# D287 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d287-history-diff-v1"
BOUNDARY = "glio-noncode-d287-history-diff"
