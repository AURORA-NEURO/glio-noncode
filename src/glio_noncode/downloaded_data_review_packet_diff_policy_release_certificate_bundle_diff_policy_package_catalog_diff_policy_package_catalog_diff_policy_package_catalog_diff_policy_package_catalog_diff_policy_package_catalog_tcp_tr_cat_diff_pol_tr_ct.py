...
VERSION = "downloaded-data-fixed-transport-catalog-diff-policy-package-catalog-diff-policy-transport-v1"
BOUNDARY = "public_downloaded_data_fixed_transport_catalog_diff_policy_package_catalog_diff_policy_transport"
PACKAGE_PREFIX = "glio-noncode-fixed-transport-catalog-diff-policy-package-catalog-diff-policy-transport"
