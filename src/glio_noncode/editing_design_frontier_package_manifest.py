...
class EditingDesignPackageManifestPlane:
    plane_id: str
    values: dict[str, Any]
    accepted: bool
    content_address: str
...
def build_editing_design_package_manifest(**kwargs: Any) -> EditingDesignPackageManifestPlane:
    ...
    return EditingDesignPackageManifestPlane(**body, content_address=content_hash(body))

__all__ = ["EditingDesignPackageManifestPlane", "build_editing_design_package_manifest"]
