"""Independent workbench release checks assurance plane.
...
class WorkbenchReleaseWorkbenchReleaseChecks:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_release_checks(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchReleaseChecks:
    ...
    return WorkbenchReleaseWorkbenchReleaseChecks(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_release_checks(receipt: WorkbenchReleaseWorkbenchReleaseChecks, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_release_checks(receipt: WorkbenchReleaseWorkbenchReleaseChecks) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchReleaseChecks", "validate_workbench_release_workbench_release_checks", "build_workbench_release_workbench_release_checks", "summarize_workbench_release_workbench_release_checks"]
