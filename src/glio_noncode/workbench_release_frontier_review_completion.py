"""Independent review completion assurance plane.
...
class WorkbenchReleaseReviewCompletion:
    count: int
    accepted: bool
...
def build_workbench_release_review_completion(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseReviewCompletion:
    ...
    return WorkbenchReleaseReviewCompletion(**body, content_address=content_hash(body))


def validate_workbench_release_review_completion(receipt: WorkbenchReleaseReviewCompletion, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_review_completion(receipt: WorkbenchReleaseReviewCompletion) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseReviewCompletion", "validate_workbench_release_review_completion", "build_workbench_release_review_completion", "summarize_workbench_release_review_completion"]
