"""Independent workbench run manifest assurance plane.
...
class WorkbenchReleaseWorkbenchRunManifest:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_run_manifest(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchRunManifest:
    ...
    return WorkbenchReleaseWorkbenchRunManifest(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_run_manifest(receipt: WorkbenchReleaseWorkbenchRunManifest, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_run_manifest(receipt: WorkbenchReleaseWorkbenchRunManifest) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchRunManifest", "validate_workbench_release_workbench_run_manifest", "build_workbench_release_workbench_run_manifest", "summarize_workbench_release_workbench_run_manifest"]
