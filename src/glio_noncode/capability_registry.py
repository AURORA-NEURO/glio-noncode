        ...
        for record in self.records():
            ...
            updated.append(
                CapabilityRecord(
                    ...
                    + (
                        (
                            "glio_noncode.reference_architecture_operations.evaluate_reference_architecture_fixture",
                            "glio_noncode.reference_architecture_runtime.run_reference_architecture",
                            "glio_noncode.reference_architecture_quality.assess_reference_architecture_quality",
                        )
                    ...
                    + (
                        (
                            "glio_noncode.chromatin_architecture_operations.evaluate_chromatin_architecture_fixture",
                            "glio_noncode.chromatin_architecture_runtime.run_chromatin_architecture",
                            "glio_noncode.chromatin_architecture_quality.assess_chromatin_architecture_quality",
                        )
                    ...
                    + (
                        (
                            "glio_noncode.link_graph_architecture_operations.evaluate_link_graph_architecture_fixture",
                            "glio_noncode.link_graph_architecture_runtime.run_link_graph_architecture",
                            "glio_noncode.link_graph_architecture_quality.assess_link_graph_architecture_quality",
                        )
                        if record.spec.capability_id.startswith("GNC-D10-")
                        else ()
                    )
                    + (
                        (
                            "glio_noncode.causal_architecture_operations.evaluate_causal_architecture_fixture",
                            "glio_noncode.causal_architecture_runtime.run_causal_architecture",
                            "glio_noncode.causal_architecture_quality.assess_causal_architecture_quality",
                        )
                    ...
                    + (
                        (
                            "glio_noncode.workbench_architecture_operations.evaluate_workbench_architecture_fixture",
                            "glio_noncode.workbench_architecture_runtime.run_workbench_architecture",
                            "glio_noncode.workbench_architecture_quality.assess_workbench_architecture_quality",
                        )
                        if record.spec.capability_id.startswith("GNC-D15-")
                        else ()
                    )
                    + (
                        (
                            "glio_noncode.platform_execution_architecture_operations.evaluate_platform_execution_fixture",
                            "glio_noncode.platform_execution_architecture_runtime.run_platform_execution_architecture",
                            "glio_noncode.platform_execution_architecture_quality.assess_platform_execution_quality",
                        )
                        if record.spec.capability_id.startswith("GNC-D16-")
                        else ()
                    ),
                    ...
                    + (
                        (
                            "tests.test_reference_architecture",
                    ...
                    + (
                        (
                            "tests.test_chromatin_architecture",
                    ...
                    + (
                        (
                            "tests.test_workbench_architecture",
                            "tests.test_workbench_architecture_exports",
                        )
                        if record.spec.capability_id.startswith("GNC-D15-")
                        else ()
                    )
