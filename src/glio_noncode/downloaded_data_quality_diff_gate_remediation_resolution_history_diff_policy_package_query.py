...
VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-policy-package-query-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_package_query"
QUERY_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff-policy-package-query"
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow:
    FIELDS = ROW_FIELDS
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow:
...
def address_row(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery:
    ...
    def __init__(self, package_address: str, version: str, boundary: str, resources: Sequence[str], resource: str, passed: bool | None, text: str, offset: int, limit: int, total_count: int, matched_count: int, returned_count: int, next_offset: int, truncated: bool, rows: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.rows = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow.from_mapping(item) for item in _sequence(rows, "history diff policy package query rows", MAX_LIMIT))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery:
        value = _mapping(value, "history diff policy package query")
        _strict(value, set(cls.FIELDS), "history diff policy package query")
        return cls(*(value[field] for field in cls.FIELDS))


def address_query(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery):
        raise ValidationError("history diff policy package query address requires a typed query")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=QUERY_PREFIX)


def _row(ordinal: int, resource: str, identity: str, passed: bool, category: str, observed: str, detail: str) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow(**(body | {"content_address": address_row(provisional)}))


def _rows(value: package_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage, resources: Sequence[str]) -> tuple[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow, ...]:
    ordinal = 1
    rows: list[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow] = []
    ...
    if "runtime-checks" in resources:
        for item in value.runtime.audit.checks:
...
def _matches(row: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow, query: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery) -> bool:
...
def query_package(value: package_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage, *, resources: Sequence[str] = RESOURCES, resource: str = "", passed: bool | None = None, text: str = "", offset: int = 0, limit: int = MAX_LIMIT) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery(value.content_address, VERSION, BOUNDARY, resources, resource, passed, text, offset, limit, 0, 0, 0, offset, False, (), QUERY_PREFIX + ":pending")
    ...
    result = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery(**(body | {"content_address": address_query(result)}))


def _readdress(row: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow, ordinal: int) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow:
    body = row.to_dict() | {"ordinal": ordinal, "content_address": ROW_PREFIX + ":pending"}
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow(**(body | {"content_address": address_row(provisional)}))


def query_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery.from_mapping(value)


def query_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery) -> str:
    return canonical_json(query_from_mapping(value.to_dict()).to_dict())


def query_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery) -> str:
...
def render_query_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery) -> str:
    value = query_from_mapping(value.to_dict())
    lines = ["# Downloaded Data Quality Diff Gate Remediation Resolution History Diff Policy Package Query", "", f"- Package: `{value.package_address}`", f"- Matched: `{value.matched_count}`", f"- Returned: `{value.returned_count}`", f"- Truncated: `{value.truncated}`", f"- Address: `{value.content_address}`", "", "| # | resource | identity | passed | category |", "| ---: | --- | --- | ---: | --- |"]
    lines.extend(f"| {row.ordinal} | `{row.resource}` | `{row.identity}` | `{row.passed}` | `{row.category}` |" for row in value.rows)
    return "\n".join(lines) + "\n"


def row_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy package query row", "type": "object", "additionalProperties": False, "required": list(ROW_FIELDS), "properties": {"ordinal": {"type": "integer", "minimum": 1, "maximum": MAX_TOTAL_COUNT}, "resource": {"enum": list(RESOURCES)}, "identity": {"type": "string"}, "passed": {"type": "boolean"}, "category": {"type": "string"}, "observed": {"type": "string"}, "detail": {"type": "string"}, "content_address": {"type": "string"}}}


def query_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy package query", "type": "object", "additionalProperties": False, "required": list(QUERY_FIELDS), "properties": {"package_address": {"type": "string"}, "version": {"const": VERSION}, "boundary": {"const": BOUNDARY}, "resources": {"type": "array", "items": {"enum": list(RESOURCES)}}, "resource": {"type": "string"}, "passed": {"type": ["boolean", "null"]}, "text": {"type": "string"}, "offset": {"type": "integer", "minimum": 0}, "limit": {"type": "integer", "minimum": 1}, "total_count": {"type": "integer", "minimum": 0}, "matched_count": {"type": "integer", "minimum": 0}, "returned_count": {"type": "integer", "minimum": 0}, "next_offset": {"type": "integer", "minimum": 0}, "truncated": {"type": "boolean"}, "rows": {"type": "array", "items": row_schema(), "maxItems": MAX_LIMIT}, "content_address": {"type": "string"}}}
...
__all__ = ["BOUNDARY", "MAX_LIMIT", "MAX_TOTAL_COUNT", "QUERY_FIELDS", "QUERY_PREFIX", "RESOURCES", "ROW_FIELDS", "ROW_PREFIX", "VERSION", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQuery", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageQueryRow", "address_query", "address_row", "capabilities", "query_csv", "query_from_mapping", "query_json", "query_package", "query_schema", "render_query_markdown", "row_schema"]
