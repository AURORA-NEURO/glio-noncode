"""Independent search facets assurance plane.
...
class WorkbenchReleaseSearchFacets:
    count: int
    accepted: bool
...
def build_workbench_release_search_facets(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseSearchFacets:
    ...
    return WorkbenchReleaseSearchFacets(**body, content_address=content_hash(body))


def validate_workbench_release_search_facets(receipt: WorkbenchReleaseSearchFacets, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_search_facets(receipt: WorkbenchReleaseSearchFacets) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseSearchFacets", "validate_workbench_release_search_facets", "build_workbench_release_search_facets", "summarize_workbench_release_search_facets"]
