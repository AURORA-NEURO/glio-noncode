...
from . import (
    downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_runtime as runtime_model,
)
from . import (
...
VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-policy-package-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_package"
PACKAGE_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff-policy-package"
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest:
...
def address_manifest(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary:
        value = _mapping(value, "history diff policy package summary")
        _strict(value, set(cls.FIELDS), "history diff policy package summary")
        return cls(*(value[field] for field in cls.FIELDS))


def address_summary(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage:
    FIELDS = PACKAGE_FIELDS

    def __init__(self, package_id: str, version: str, boundary: str, runtime_address: str, policy_audit_address: str, runtime_audit_address: str, policy_id: str, evaluation_id: str, direction: str, state: str, decision: str, accepted: bool, release_ready: bool, policy_rule_count: int, passed_rule_count: int, failed_rule_count: int, manifest: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest | Mapping[str, Any], summary: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary | Mapping[str, Any], runtime: runtime_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime | Mapping[str, Any], policy_audit: policy_audit_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyAudit | Mapping[str, Any], runtime_audit: runtime_audit_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeAudit | Mapping[str, Any], content_address: str) -> None:
        ...
        self.manifest = manifest if isinstance(manifest, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest.from_mapping(manifest)
        self.summary = summary if isinstance(summary, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary.from_mapping(summary)
        self.runtime = runtime if isinstance(runtime, runtime_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime) else runtime_model.runtime_from_mapping(runtime)
        self.policy_audit = policy_audit if isinstance(policy_audit, policy_audit_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyAudit) else policy_audit_model.audit_from_mapping(policy_audit)
        self.runtime_audit = runtime_audit if isinstance(runtime_audit, runtime_audit_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntimeAudit) else runtime_audit_model.audit_from_mapping(runtime_audit)
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage:
        value = _mapping(value, "history diff policy package")
        _strict(value, set(cls.FIELDS), "history diff policy package")
        return cls(*(value[field] for field in cls.FIELDS))


def address_package(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage):
...
def build_package(runtime: runtime_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime, *, package_id: str = DEFAULT_PACKAGE_ID) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage:
    if not isinstance(runtime, runtime_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime):
    ...
    summary_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary(**summary_body)
    summary = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary(**(summary_body | {"content_address": address_summary(summary_provisional)}))
    ...
    manifest_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest(**manifest_body, content_address=MANIFEST_PREFIX + ":pending")
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest(**manifest_body, content_address=address_manifest(manifest_provisional))
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage(**body, content_address=PACKAGE_PREFIX + ":pending")
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage(**body, content_address=address_package(provisional))


def package_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage.from_mapping(value)


def package_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage) -> str:
    return canonical_json(package_from_mapping(value.to_dict()).to_dict())


def package_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage) -> str:
...
def render_package_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage) -> str:
    value = package_from_mapping(value.to_dict())
    lines = ["# Downloaded Data Quality Diff Gate Remediation Resolution History Diff Policy Package", "", f"- Package: `{value.package_id}`", f"- Decision: `{value.decision}`", f"- State: `{value.state}`", f"- Direction: `{value.direction}`", f"- Rules: `{value.passed_rule_count}/{value.policy_rule_count}`", f"- Accepted: `{value.accepted}`", f"- Release ready: `{value.release_ready}`", f"- Address: `{value.content_address}`", "", "| artifact | address |", "| --- | --- |"]
...
def persist_package(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage, destination: str | Path, *, overwrite: bool = False) -> Path:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage):
...
def load_package(destination: str | Path) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage:
    destination = Path(destination)
    try:
    ...
    package = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage(
    ...
    package = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage(**(package.to_dict() | {"content_address": address_package(package)}))
    if package.manifest.to_dict() != DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest.from_mapping(raw["manifest.json"]).to_dict() or package.to_dict()["content_address"] != address_package(package):
        raise ValidationError("history diff policy package artifacts do not replay")
    return package


def run_package(runtime: runtime_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyRuntime, *, package_id: str = DEFAULT_PACKAGE_ID, destination: str | Path | None = None, overwrite: bool = False) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage:
...
def manifest_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy package manifest", "type": "object", "additionalProperties": False, "required": list(MANIFEST_FIELDS), "properties": {"package_id": {"type": "string"}, "files": {"const": list(FILES)}, "artifact_addresses": {"type": "array", "items": {"type": "string"}, "minItems": MAX_ARTIFACTS, "maxItems": MAX_ARTIFACTS}, "content_address": {"type": "string"}}}


def summary_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy package summary", "type": "object", "additionalProperties": False, "required": list(SUMMARY_FIELDS), "properties": {"package_id": {"type": "string"}, "runtime_address": {"type": "string"}, "policy_audit_address": {"type": "string"}, "runtime_audit_address": {"type": "string"}, "policy_id": {"type": "string"}, "evaluation_id": {"type": "string"}, "direction": {"type": "string"}, "state": {"enum": ["complete", "incomplete"]}, "decision": {"enum": list(policy_model.DECISIONS)}, "accepted": {"type": "boolean"}, "release_ready": {"type": "boolean"}, "policy_rule_count": {"type": "integer", "minimum": 0}, "passed_rule_count": {"type": "integer", "minimum": 0}, "failed_rule_count": {"type": "integer", "minimum": 0}, "content_address": {"type": "string"}}}


def package_schema() -> dict[str, Any]:
    return {"$schema": "https://json-schema.org/draft/2020-12/schema", "title": "Downloaded data quality diff gate remediation resolution history diff policy package", "type": "object", "additionalProperties": False, "required": list(PACKAGE_FIELDS), "properties": {"package_id": {"type": "string"}, "version": {"const": VERSION}, "boundary": {"const": BOUNDARY}, "runtime_address": {"type": "string"}, "policy_audit_address": {"type": "string"}, "runtime_audit_address": {"type": "string"}, "policy_id": {"type": "string"}, "evaluation_id": {"type": "string"}, "direction": {"type": "string"}, "state": {"enum": ["complete", "incomplete"]}, "decision": {"enum": list(policy_model.DECISIONS)}, "accepted": {"type": "boolean"}, "release_ready": {"type": "boolean"}, "policy_rule_count": {"type": "integer", "minimum": 0}, "passed_rule_count": {"type": "integer", "minimum": 0}, "failed_rule_count": {"type": "integer", "minimum": 0}, "manifest": manifest_schema(), "summary": summary_schema(), "runtime": runtime_model.runtime_schema(), "policy_audit": policy_audit_model.audit_schema(), "runtime_audit": runtime_audit_model.audit_schema(), "content_address": {"type": "string"}}}
...
__all__ = ["BOUNDARY", "DEFAULT_PACKAGE_ID", "FILES", "MANIFEST_ARTIFACT_FILES", "MANIFEST_FIELDS", "MAX_ARTIFACTS", "PACKAGE_FIELDS", "PACKAGE_PREFIX", "SUMMARY_FIELDS", "SUMMARY_PREFIX", "VERSION", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackage", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageManifest", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageSummary", "address_manifest", "address_package", "address_summary", "build_package", "capabilities", "load_package", "manifest_schema", "package_csv", "package_from_mapping", "package_json", "package_schema", "persist_package", "render_package_markdown", "run_package", "summary_schema"]
