"""Independent workbench data dictionary assurance plane.
...
class WorkbenchReleaseWorkbenchDataDictionary:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_data_dictionary(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchDataDictionary:
    ...
    return WorkbenchReleaseWorkbenchDataDictionary(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_data_dictionary(receipt: WorkbenchReleaseWorkbenchDataDictionary, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_data_dictionary(receipt: WorkbenchReleaseWorkbenchDataDictionary) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchDataDictionary", "validate_workbench_release_workbench_data_dictionary", "build_workbench_release_workbench_data_dictionary", "summarize_workbench_release_workbench_data_dictionary"]
