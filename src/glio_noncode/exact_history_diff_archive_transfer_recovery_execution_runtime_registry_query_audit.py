...
from . import exact_history_diff_archive_transfer_recovery_execution_runtime_registry_query as query_model
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck:
...
def address_check(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck):
        raise ValidationError("history-diff runtime registry query audit check address requires a typed check")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=CHECK_PREFIX)


class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit:
    """A fixed-size independently recomputed query assurance result."""

    FIELDS = AUDIT_FIELDS

    def __init__(self, query_address: str, registry_address: str, query_id: str, registry_id: str, version: str, boundary: str, check_count: int, passed_count: int, failed_count: int, accepted: bool, checks: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.checks = tuple(item if isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck.from_mapping(item) for item in _sequence(checks, "history-diff runtime registry query audit checks", MAX_CHECKS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit:
...
def address_audit(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit):
        raise ValidationError("history-diff runtime registry query audit address requires a typed audit")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=AUDIT_PREFIX)


def value_model_version(value: query_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery) -> str:
    """Read the version through the typed query without broadening its fields."""
    if not isinstance(value, query_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery):
        raise ValidationError("history-diff runtime registry query audit requires a typed query")
    return query_model.VERSION


def audit_query(value: query_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQuery, registry: registry_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit:
    ...
    checks: list[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck] = []
    ...
    def add(check_id: str, passed: bool, detail: str, evidence: Sequence[str] = ()) -> None:
        ...
        provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck(**body)
        checks.append(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAuditCheck(**(body | {"content_address": address_check(provisional)})))
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit(**body)
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit(**(body | {"content_address": address_audit(provisional)}))


def verify_audit(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit):
        raise ValidationError("history-diff runtime registry query audit verification requires a typed audit")
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit.from_mapping(value.to_dict())


def audit_from_mapping(value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit:
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit.from_mapping(value)


def audit_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit) -> str:
    return canonical_json(verify_audit(value).to_dict())


def audit_csv(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit) -> str:
...
def render_audit_markdown(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryQueryAudit) -> str:
    value = verify_audit(value)
