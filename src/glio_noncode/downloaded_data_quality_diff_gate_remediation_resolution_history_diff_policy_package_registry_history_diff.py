...
from . import (
    downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_package_registry as registry_model,
)
from . import (
    downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_package_registry_history as history_model,
)
from ._safe_persistence import _validate_parent, atomic_write_bytes, read_text
from .errors import ValidationError
from .serialization import _strict_json_loads, canonical_json, content_hash

VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-policy-package-registry-history-diff-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff_policy_package_registry_history_diff"
DIFF_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff-policy-package-registry-history-diff"
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem:
    FIELDS = ITEM_FIELDS
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem:
        value = _mapping(value, "registry history diff item")
        _strict(value, set(cls.FIELDS), "registry history diff item")
        return cls(*(value[field] for field in cls.FIELDS))


def address_item(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItems:
    FIELDS = ITEMS_FIELDS

    def __init__(self, items: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem | Mapping[str, Any]], content_address: str) -> None:
        self.items = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem.from_mapping(item) for item in _sequence(items, "registry history diff items", MAX_ITEMS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItems:
...
def address_items(value: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem]) -> str:
    typed = tuple(value)
    if any(not isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem) for item in typed):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest:
        value = _mapping(value, "registry history diff manifest")
        _strict(value, set(cls.FIELDS), "registry history diff manifest")
        return cls(*(value[field] for field in cls.FIELDS))


def address_manifest(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary:
        value = _mapping(value, "registry history diff summary")
        _strict(value, set(cls.FIELDS), "registry history diff summary")
        return cls(*(value[field] for field in cls.FIELDS))


def address_summary(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff:
    FIELDS = DIFF_FIELDS

    def __init__(self, diff_id: str, version: str, boundary: str, left_history_address: str, right_history_address: str, left_entry_count: int, right_entry_count: int, added_count: int, removed_count: int, changed_count: int, unchanged_count: int, initial_delta: int, improved_delta: int, regressed_delta: int, unchanged_delta: int, changed_delta: int, left_state: str, right_state: str, direction: str, state_transition: str, manifest: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest | Mapping[str, Any], summary: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary | Mapping[str, Any], items: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.manifest = manifest if isinstance(manifest, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest.from_mapping(manifest)
        self.summary = summary if isinstance(summary, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary.from_mapping(summary)
        self.items = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem.from_mapping(item) for item in _sequence(items, "registry history diff items", MAX_ITEMS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff:
        value = _mapping(value, "registry history diff")
        _strict(value, set(cls.FIELDS), "registry history diff")
        return cls(*(value[field] for field in cls.FIELDS))


def address_diff(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff):
...
def _entry_snapshot(value: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryEntry) -> dict[str, Any]:
    return {key: getattr(value, key) for key in SNAPSHOT_FIELDS}


def _item(ordinal: int, left: Any | None, right: Any | None) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem(**(body | {"content_address": address_item(provisional)}))


def _history_summary(value: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory) -> dict[str, Any]:
...
def build_diff(left: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory, right: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory, *, diff_id: str = DEFAULT_DIFF_ID) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff:
    if not isinstance(left, history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory) or not isinstance(right, history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory):
    ...
    summary_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary(**summary_body)
    summary = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary(**(summary_body | {"content_address": address_summary(summary_provisional)}))
    ...
    manifest_provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest(**manifest_body)
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest(**(manifest_body | {"content_address": address_manifest(manifest_provisional)}))
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff(**(body | {"content_address": address_diff(provisional)}))


def diff_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff.from_mapping(value)


def diff_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff) -> str:
    return canonical_json(diff_from_mapping(value.to_dict()).to_dict())


def diff_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff) -> str:
...
def render_diff_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff) -> str:
    value = diff_from_mapping(value.to_dict())
...
def items_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItems) -> str:
    return canonical_json(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItems.from_mapping(value.to_dict()).to_dict())


def summary_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary) -> str:
    return canonical_json(DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary.from_mapping(value.to_dict()).to_dict())
...
def _write(path: Path, value: Any) -> None:
    atomic_write_bytes(
        ...
        field="registry history diff document",
    )


def persist_diff(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff, destination: str | Path, *, overwrite: bool = False) -> Path:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff):
    ...
    try:
        items = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItems(value.items, address_items(value.items))
...
def _read_canonical(path: Path, value: Mapping[str, Any]) -> None:
    try:
        actual = read_text(path, field="registry history diff artifact")
...
def load_diff(destination: str | Path) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff:
    destination = Path(destination)
    try:
        _validate_parent(destination.parent, "registry history diff input")
        if destination.is_symlink() or not destination.is_dir():
            raise ValidationError("registry history diff destination must be a directory")
    except ValidationError:
        raise
    except OSError as error:
        raise ValidationError("registry history diff input could not be inspected") from error
    ...
    items = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItems.from_mapping(raw["items.json"])
    manifest = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest.from_mapping(raw["manifest.json"])
    summary = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary.from_mapping(raw["summary.json"])
...
def run_diff(left: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory, right: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistory, *, diff_id: str = DEFAULT_DIFF_ID, destination: str | Path | None = None, overwrite: bool = False) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff:
...
__all__ = ["BOUNDARY", "CHANGES", "DEFAULT_DIFF_ID", "DIFF_FIELDS", "DIFF_PREFIX", "DIRECTIONS", "FILES", "ITEM_FIELDS", "ITEM_PREFIX", "ITEMS_FIELDS", "MANIFEST_ARTIFACT_FILES", "MANIFEST_FIELDS", "MAX_ITEMS", "SNAPSHOT_FIELDS", "SUMMARY_FIELDS", "SUMMARY_PREFIX", "VERSION", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiff", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItem", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffItems", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffManifest", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffPolicyPackageRegistryHistoryDiffSummary", "address_diff", "address_item", "address_items", "address_manifest", "address_summary", "build_diff", "capabilities", "diff_csv", "diff_from_mapping", "diff_json", "diff_schema", "item_schema", "items_json", "items_schema", "load_diff", "manifest_schema", "persist_diff", "render_diff_markdown", "run_diff", "summary_json", "summary_schema"]
