"""Source-to-operation-to-case lineage for D14."""
...
def evidence_architecture_lineage_rows(
    ...
    for case in selected.cases:
        ...
        for source_id in case.source_ids:
            ...
            rows.append(
                body | {"lineage_address": addressed(body, "evidence-architecture-lineage")}
            )
    return tuple(rows)


def evidence_architecture_lineage_gaps(
    fixture: EvidenceArchitectureFixture | None = None,
) -> tuple[str, ...]:
    selected = fixture or default_evidence_architecture_fixture()
...
def evidence_architecture_lineage_summary(
    fixture: EvidenceArchitectureFixture | None = None,
) -> dict[str, object]:
    selected = fixture or default_evidence_architecture_fixture()
    rows = evidence_architecture_lineage_rows(selected)
    return {
        ...
        "gap_count": len(evidence_architecture_lineage_gaps(selected)),
...
__all__ = [
    ...
    "evidence_architecture_lineage_summary",
]
