...
from . import downloaded_data_quality_d358_runtime_registry_history as history_model
...
# D359 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d359-history-diff-v1"
BOUNDARY = "glio-noncode-d359-history-diff"
