...
def audit_policy(value: Any, *, diff: Any | None = None) -> Audit:
    try:
        ...
        checks = (
            ...
            _check("audit-diff-lineage", policy.diff_address.startswith(diff_model.DIFF_PREFIX + ":"), policy.diff_address, "diff namespace", "policy retains a fixed transport catalog-diff policy package catalog diff lineage address"),
