"""Source-to-receipt lineage for C13-C16."""
...
class FrontierAtlasLineageEdge:
    edge_id: str
    record_id: str
...
@dataclass(frozen=True, slots=True)
class FrontierAtlasLineageReport:
    fixture_id: str
    fixture_address: str
    edges: tuple[FrontierAtlasLineageEdge, ...]
    source_ids: tuple[str, ...]
    content_address: str
...
def build_frontier_atlas_lineage(
    ...
    edges: list[FrontierAtlasLineageEdge] = []
    for receipt in evaluation.receipts:
        ...
        body = {
            ...
            "transformation": "parse public aggregate payload, apply declared frontier adapter, emit sanitized receipt",
        }
        edges.append(
    ...
    return FrontierAtlasLineageReport(
        fixture.fixture_id,
...
def verify_frontier_atlas_lineage(
