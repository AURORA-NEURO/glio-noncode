...
from . import downloaded_data_quality_d442_runtime_registry_history as history_model
...
# D443 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d443-history-diff-v1"
BOUNDARY = "glio-noncode-d443-history-diff"
