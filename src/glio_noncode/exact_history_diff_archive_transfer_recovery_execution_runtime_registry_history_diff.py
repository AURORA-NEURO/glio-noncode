"""Deterministic baseline/candidate diff for exact runtime-registry histories."""
...
def _quality(value: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> tuple[int, int, int, int, int, int]:
...
def _direction(left: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory, right: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory, item_change: bool) -> str:
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem:
...
def address_item(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem):
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItems:
    """Ordered and addressed diff-item projection."""

    FIELDS = ITEMS_FIELDS

    def __init__(self, items: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem | Mapping[str, Any]], content_address: str) -> None:
        self.items = tuple(item if isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem.from_mapping(item) for item in _sequence(items, "runtime registry history diff items", MAX_ITEMS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItems:
...
def address_items(value: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem]) -> str:
    typed = tuple(value)
    if any(not isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem) for item in typed):
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest:
...
def address_manifest(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest):
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary:
...
def address_summary(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary):
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff:
    """Fully addressed baseline/candidate history comparison."""

    FIELDS = DIFF_FIELDS

    def __init__(self, diff_id: str, version: str, boundary: str, left_history_id: str, right_history_id: str, left_history_address: str, right_history_address: str, item_count: int, added_count: int, removed_count: int, changed_count: int, unchanged_count: int, direction: str, accepted: bool, manifest: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest | Mapping[str, Any], summary: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary | Mapping[str, Any], items: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem | Mapping[str, Any]], content_address: str) -> None:
        self.diff_id = _label(diff_id, "runtime registry history diff ID")
        self.version = _text(version, "runtime registry history diff version", 1024)
        self.boundary = _text(boundary, "runtime registry history diff boundary", 1024)
        self.left_history_id = _label(left_history_id, "runtime registry history diff left history ID", required=False)
        ...
        self.direction = direction
        self.accepted = _bool(accepted, "runtime registry history diff acceptance")
        self.manifest = manifest if isinstance(manifest, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest.from_mapping(manifest)
        self.summary = summary if isinstance(summary, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary.from_mapping(summary)
        self.items = tuple(item if isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem.from_mapping(item) for item in _sequence(items, "runtime registry history diff items", MAX_ITEMS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff:
        value = _mapping(value, "runtime registry history diff")
        _strict(value, set(cls.FIELDS), "runtime registry history diff")
        return cls(*(value[field] for field in cls.FIELDS))


def address_diff(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff):
...
def _item(ordinal: int, left: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry | None, right: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry | None) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem:
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem(**body)
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItem(**(body | {"content_address": address_item(provisional)}))


def build_diff(left: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory, right: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory, *, diff_id: str = DEFAULT_DIFF_ID) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff:
    ...
    summary_provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary(**summary_body)
    summary = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary(**(summary_body | {"content_address": address_summary(summary_provisional)}))
    ...
    manifest_provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest(**manifest_body)
    manifest = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest(**(manifest_body | {"content_address": address_manifest(manifest_provisional)}))
    body = {
        "diff_id": diff_id,
        "version": VERSION,
        "boundary": BOUNDARY,
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff(**body)
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff(**(body | {"content_address": address_diff(provisional)}))


def verify_diff(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff):
        raise ValidationError("runtime registry history diff verification requires a typed diff")
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff.from_mapping(value.to_dict())


def diff_from_mapping(value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff:
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff.from_mapping(value)


def diff_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> str:
    return canonical_json(verify_diff(value).to_dict())


def diff_csv(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> str:
...
def render_diff_markdown(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff) -> str:
    value = verify_diff(value)
    lines = [
...
def items_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItems) -> str:
    return canonical_json(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItems.from_mapping(value.to_dict()).to_dict())


def summary_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary) -> str:
    return canonical_json(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary.from_mapping(value.to_dict()).to_dict())


def manifest_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest) -> str:
    return canonical_json(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest.from_mapping(value.to_dict()).to_dict())
...
def load_diff(destination: str | Path) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff:
    ...
    manifest = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffManifest.from_mapping(documents["manifest.json"])
    items = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffItems.from_mapping(documents["items.json"])
    summary = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffSummary.from_mapping(documents["summary.json"])
...
def run_diff(left: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory, right: history_model.ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory, *, diff_id: str = DEFAULT_DIFF_ID, destination: str | Path | None = None, overwrite: bool = False) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiff:
