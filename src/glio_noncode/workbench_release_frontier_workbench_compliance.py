"""Independent workbench compliance assurance plane.
...
class WorkbenchReleaseWorkbenchCompliance:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_compliance(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchCompliance:
    ...
    return WorkbenchReleaseWorkbenchCompliance(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_compliance(receipt: WorkbenchReleaseWorkbenchCompliance, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_compliance(receipt: WorkbenchReleaseWorkbenchCompliance) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchCompliance", "validate_workbench_release_workbench_compliance", "build_workbench_release_workbench_compliance", "summarize_workbench_release_workbench_compliance"]
