...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry:
        value = _mapping(value, "runtime registry history entry")
        _strict(value, set(cls.FIELDS), "runtime registry history entry")
        return cls(*(value[field] for field in cls.FIELDS))


def address_entry(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry):
...
def entry_from_registry(value: registry_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry, ordinal: int, transition: str, previous_registry_address: str) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry:
    if not isinstance(value, registry_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry):
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry(**(body | {"content_address": address_entry(provisional)}))


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntries:
    """Ordered and addressed snapshot projection persisted beside a history."""

    FIELDS = ENTRIES_FIELDS

    def __init__(self, entries: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry | Mapping[str, Any]], content_address: str) -> None:
        self.entries = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry.from_mapping(item) for item in _sequence(entries, "runtime registry history entries", MAX_ENTRIES))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntries:
...
def address_entries(value: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry]) -> str:
    typed = tuple(value)
    if any(not isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry) for item in typed):
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest:
        value = _mapping(value, "runtime registry history manifest")
        _strict(value, set(cls.FIELDS), "runtime registry history manifest")
        return cls(*(value[field] for field in cls.FIELDS))


def address_manifest(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest):
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary:
        value = _mapping(value, "runtime registry history summary")
        _strict(value, set(cls.FIELDS), "runtime registry history summary")
        return cls(*(value[field] for field in cls.FIELDS))


def address_summary(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary):
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory:
    """Deterministic append-only history of one registry identity."""

    FIELDS = HISTORY_FIELDS

    def __init__(self, history_id: str, registry_id: str, version: str, boundary: str, entry_count: int, latest_registry_address: str, latest_entry_count: int, latest_accepted_count: int, latest_ready_count: int, latest_blocked_count: int, initial_count: int, improved_count: int, regressed_count: int, unchanged_count: int, changed_count: int, state: str, accepted: bool, manifest: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest | Mapping[str, Any], summary: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary | Mapping[str, Any], entries: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.manifest = manifest if isinstance(manifest, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest.from_mapping(manifest)
        self.summary = summary if isinstance(summary, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary.from_mapping(summary)
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory:
        value = _mapping(value, "runtime registry history")
        _strict(value, set(cls.FIELDS), "runtime registry history")
        return cls(*(value[field] for field in cls.FIELDS))


def address_history(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory):
...
def build_history(registries: Sequence[registry_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry], *, history_id: str = DEFAULT_HISTORY_ID) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory:
    typed = tuple(_sequence(registries, "runtime registry history registries", MAX_ENTRIES))
    if any(not isinstance(item, registry_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry) for item in typed):
    ...
    entries: list[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry] = []
    previous: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntry | None = None
    ...
    summary_provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary(**summary_body)
    summary = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary(**(summary_body | {"content_address": address_summary(summary_provisional)}))
    ...
    manifest_provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest(**manifest_body)
    manifest = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest(**(manifest_body | {"content_address": address_manifest(manifest_provisional)}))
    body = {
        "history_id": history_id,
        "registry_id": registry_id,
        "version": VERSION,
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory(**(body | {"content_address": address_history(provisional)}))


def verify_history(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory):
        raise ValidationError("runtime registry history verification requires a typed history")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory.from_mapping(value.to_dict())


def history_from_mapping(value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory:
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory.from_mapping(value)


def history_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> str:
    return canonical_json(verify_history(value).to_dict())


def history_csv(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> str:
...
def render_history_markdown(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> str:
    value = verify_history(value)
    lines = [
...
def entries_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntries) -> str:
    return canonical_json(HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntries.from_mapping(value.to_dict()).to_dict())


def summary_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary) -> str:
    return canonical_json(HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary.from_mapping(value.to_dict()).to_dict())


def manifest_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest) -> str:
    return canonical_json(HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest.from_mapping(value.to_dict()).to_dict())


def _write(path: Path, value: Mapping[str, Any]) -> None:
    atomic_write_text(path, canonical_json(value), field="runtime registry history artifact")


def persist_history(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory, destination: str | Path, *, overwrite: bool = False) -> Path:
    value = verify_history(value)
    destination = Path(destination)
    if destination.is_symlink():
        raise ValidationError("runtime registry history destination must not be a symlink")
    ...
    try:
        entries = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntries(value.entries, address_entries(value.entries))
...
def load_history(destination: str | Path) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory:
    destination = Path(destination)
    ...
    manifest = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryManifest.from_mapping(documents["manifest.json"])
    entries = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryEntries.from_mapping(documents["entries.json"])
    summary = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistorySummary.from_mapping(documents["summary.json"])
...
def run_history(registries: Sequence[registry_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistry], *, history_id: str = DEFAULT_HISTORY_ID, destination: str | Path | None = None, overwrite: bool = False) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory:
