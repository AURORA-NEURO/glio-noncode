"""Independent report renderer assurance plane.
...
class WorkbenchReleaseReportRenderer:
    count: int
    accepted: bool
...
def build_workbench_release_report_renderer(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseReportRenderer:
    ...
    return WorkbenchReleaseReportRenderer(**body, content_address=content_hash(body))


def validate_workbench_release_report_renderer(receipt: WorkbenchReleaseReportRenderer, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_report_renderer(receipt: WorkbenchReleaseReportRenderer) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseReportRenderer", "validate_workbench_release_report_renderer", "build_workbench_release_report_renderer", "summarize_workbench_release_report_renderer"]
