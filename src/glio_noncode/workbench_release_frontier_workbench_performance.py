"""Independent workbench performance assurance plane.
...
class WorkbenchReleaseWorkbenchPerformance:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_performance(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchPerformance:
    ...
    return WorkbenchReleaseWorkbenchPerformance(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_performance(receipt: WorkbenchReleaseWorkbenchPerformance, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_performance(receipt: WorkbenchReleaseWorkbenchPerformance) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchPerformance", "validate_workbench_release_workbench_performance", "build_workbench_release_workbench_performance", "summarize_workbench_release_workbench_performance"]
