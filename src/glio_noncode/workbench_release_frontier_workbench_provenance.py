"""Independent workbench provenance assurance plane.
...
class WorkbenchReleaseWorkbenchProvenance:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_provenance(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchProvenance:
    ...
    return WorkbenchReleaseWorkbenchProvenance(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_provenance(receipt: WorkbenchReleaseWorkbenchProvenance, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_provenance(receipt: WorkbenchReleaseWorkbenchProvenance) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchProvenance", "validate_workbench_release_workbench_provenance", "build_workbench_release_workbench_provenance", "summarize_workbench_release_workbench_provenance"]
