"""Independent workbench claim boundary assurance plane.
...
class WorkbenchReleaseWorkbenchClaimBoundary:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_claim_boundary(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchClaimBoundary:
    ...
    return WorkbenchReleaseWorkbenchClaimBoundary(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_claim_boundary(receipt: WorkbenchReleaseWorkbenchClaimBoundary, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_claim_boundary(receipt: WorkbenchReleaseWorkbenchClaimBoundary) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchClaimBoundary", "validate_workbench_release_workbench_claim_boundary", "build_workbench_release_workbench_claim_boundary", "summarize_workbench_release_workbench_claim_boundary"]
