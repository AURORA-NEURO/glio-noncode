"""Independent workbench assurance assurance plane.
...
class WorkbenchReleaseWorkbenchAssurance:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_assurance(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchAssurance:
    ...
    return WorkbenchReleaseWorkbenchAssurance(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_assurance(receipt: WorkbenchReleaseWorkbenchAssurance, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_assurance(receipt: WorkbenchReleaseWorkbenchAssurance) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchAssurance", "validate_workbench_release_workbench_assurance", "build_workbench_release_workbench_assurance", "summarize_workbench_release_workbench_assurance"]
