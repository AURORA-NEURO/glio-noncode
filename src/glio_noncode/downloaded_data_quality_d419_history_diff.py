...
from . import downloaded_data_quality_d418_runtime_registry_history as history_model
...
# D419 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d419-history-diff-v1"
BOUNDARY = "glio-noncode-d419-history-diff"
