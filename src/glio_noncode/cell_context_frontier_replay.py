"""Deterministic replay receipt for the closed context fixture."""
...
class CellContextFrontierReplayReceipt:
    replay_id: str
    fixture_address: str
    ...
    def __post_init__(self) -> None:
        if (
            ...
            raise ValidationError("cell replay receipt is incomplete")
...
def replay_cell_context_frontier(
    fixture: CellContextFrontierFixture, *, replay_id: str = "cell-context-frontier-replay"
) -> CellContextFrontierReplayReceipt:
    first = evaluate_cell_context_frontier_fixture(fixture)
    second = evaluate_cell_context_frontier_fixture(fixture)
    ...
    return CellContextFrontierReplayReceipt(
        replay_id,
...
__all__ = ["CellContextFrontierReplayReceipt", "replay_cell_context_frontier"]
