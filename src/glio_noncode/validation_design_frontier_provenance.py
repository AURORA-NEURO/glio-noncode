"""provenance links across the planning run."""
...
class ValidationDesignProvenancePlane:
    plane_id: str
    values: dict[str, Any]
    accepted: bool
    content_address: str
...
def build_validation_design_provenance(**kwargs: Any) -> ValidationDesignProvenancePlane:
    ...
    return ValidationDesignProvenancePlane(**body, content_address=content_hash(body))

__all__ = ["ValidationDesignProvenancePlane", "build_validation_design_provenance"]
