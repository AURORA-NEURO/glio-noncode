...
from . import downloaded_data_quality_d326_runtime_registry_history as history_model
...
# D327 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d327-history-diff-v1"
BOUNDARY = "glio-noncode-d327-history-diff"
