...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck:
...
def address_check(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck):
        raise ValidationError("runtime registry history audit check address requires a typed check")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=CHECK_PREFIX)


class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit:
    """A fixed-size independently recomputed history audit."""

    FIELDS = AUDIT_FIELDS

    def __init__(self, history_address: str, history_id: str, version: str, boundary: str, check_count: int, passed_count: int, failed_count: int, accepted: bool, checks: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.checks = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck.from_mapping(item) for item in _sequence(checks, "runtime registry history audit checks", MAX_CHECKS))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit:
        value = _mapping(value, "runtime registry history audit")
        _strict(value, set(cls.FIELDS), "runtime registry history audit")
        return cls(*(value[field] for field in cls.FIELDS))


def address_audit(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit):
        raise ValidationError("runtime registry history audit address requires a typed audit")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=AUDIT_PREFIX)


def _check(check_id: str, passed: bool, detail: str, evidence: Sequence[str]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAuditCheck(**(body | {"content_address": address_check(provisional)}))


def audit_history(value: history_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit(**(body | {"content_address": address_audit(provisional)}))


def verify_audit(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit):
        raise ValidationError("runtime registry history audit verification requires a typed audit")
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit.from_mapping(value.to_dict())


def audit_from_mapping(value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit:
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit.from_mapping(value)


def audit_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit) -> str:
    return canonical_json(verify_audit(value).to_dict())


def audit_csv(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit) -> str:
...
def render_audit_markdown(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryAudit) -> str:
    value = verify_audit(value)
