...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage":
        value = _mapping(value, "runtime stage")
        _strict(value, set(cls.FIELDS), "runtime stage")
        return cls(*(value[field] for field in cls.FIELDS))


class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact":
        value = _mapping(value, "runtime artifact")
        _strict(value, set(cls.FIELDS), "runtime artifact")
        return cls(*(value[field] for field in cls.FIELDS))


class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest:
    """The exact-file manifest for a persisted execution runtime."""

    FIELDS = MANIFEST_FIELDS

    def __init__(self, runtime_id: str, version: str, boundary: str, files: Sequence[str], artifacts: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact], runtime_address: str, manifest_address: str) -> None:
        ...
        self.artifacts = tuple(item if isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact.from_mapping(item) for item in _sequence(artifacts, "runtime manifest artifacts", len(ARTIFACT_FILES)))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest":
        value = _mapping(value, "runtime manifest")
        _strict(value, set(cls.FIELDS), "runtime manifest")
        return cls(value["runtime_id"], value["version"], value["boundary"], value["files"], tuple(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact.from_mapping(item) for item in _sequence(value["artifacts"], "runtime manifest artifacts", len(ARTIFACT_FILES))), value["runtime_address"], value["manifest_address"])


class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime:
    """A durable, value-free handoff for execution and its inspections."""

    FIELDS = RUNTIME_FIELDS

    def __init__(self, runtime_id: str, version: str, boundary: str, execution_id: str, execution_address: str, execution_audit_address: str, query_address: str, query_audit_address: str, stage_count: int, stages: Sequence[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage], state: str, accepted: bool, content_address: str, *, execution: Any = None, execution_audit: Any = None, query: Any = None, query_audit: Any = None) -> None:
        ...
        self.stages = tuple(item if isinstance(item, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage) else ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage.from_mapping(item) for item in _sequence(stages, "runtime stages", len(STAGES)))
        if state not in STATES:
    ...
    def _validate(self) -> None:
        ...
        if self.execution is not None:
            if not isinstance(self.execution, execution_model.ExactHistoryDiffArchiveTransferRecoveryExecution) or self.execution.execution_id != self.execution_id or self.execution.content_address != self.execution_address:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime":
        value = _mapping(value, "recovery execution runtime")
        _strict(value, set(cls.FIELDS), "recovery execution runtime")
        return cls(value["runtime_id"], value["version"], value["boundary"], value["execution_id"], value["execution_address"], value["execution_audit_address"], value["query_address"], value["query_audit_address"], value["stage_count"], tuple(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage.from_mapping(item) for item in _sequence(value["stages"], "runtime stages", len(STAGES))), value["state"], value["accepted"], value["content_address"])


def address_stage(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage):
...
def address_artifact(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact):
...
def address_manifest(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest):
...
def address_runtime(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime) -> str:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime):
...
def _stage(ordinal: int, stage: str, accepted: bool, address: str, detail: str) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage:
    pending = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage(ordinal, stage, "ready" if accepted else "blocked", accepted, address, detail, "pending:runtime-stage")
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage(ordinal, stage, pending.state, accepted, address, detail, address_stage(pending))


def _build_stages(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime, execution_audit: Any, query: Any, query_audit: Any) -> tuple[ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage, ...]:
    return (
...
def build_runtime(execution: execution_model.ExactHistoryDiffArchiveTransferRecoveryExecution, *, runtime_id: str = DEFAULT_RUNTIME_ID, resources: Sequence[str] | None = None, status: str = "", index: int = -1, text: str = "", offset: int = 0, limit: int | None = None) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime:
    from . import exact_history_diff_archive_transfer_recovery_execution_audit as execution_audit_model
    from . import exact_history_diff_archive_transfer_recovery_execution_query as query_model
    from . import exact_history_diff_archive_transfer_recovery_execution_query_audit as query_audit_model
    ...
    query_kwargs: dict[str, Any] = {"resources": resources, "status": status, "index": index, "text": text, "offset": offset}
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime(**body, stages=(_stage(1, "execution", True, execution.content_address, "execution receipt is structurally valid"), _stage(2, "audit", execution_audit.passed, execution_audit.content_address, "independent execution audit completed"), _stage(3, "query", True, query.content_address, "bounded execution query completed"), _stage(4, "query-audit", query_audit.passed, query_audit.content_address, "independent execution query audit completed"), _stage(5, "complete", accepted, query_audit.content_address, "runtime handoff is ready" if accepted else "runtime handoff is blocked by an audit result")), content_address="pending:runtime", execution=execution, execution_audit=execution_audit, query=query, query_audit=query_audit)
    stages = _build_stages(provisional, execution_audit, query, query_audit)
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime(**body, stages=stages, content_address="pending:runtime", execution=execution, execution_audit=execution_audit, query=query, query_audit=query_audit)
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime(**body, stages=stages, content_address=address_runtime(provisional), execution=execution, execution_audit=execution_audit, query=query, query_audit=query_audit)


def verify_runtime(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime:
    if not isinstance(value, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime):
...
def runtime_from_mapping(value: Mapping[str, Any]) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime:
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime.from_mapping(value)


def runtime_json(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime) -> str:
    return canonical_json(runtime_from_mapping(value.to_dict()).to_dict())


def runtime_csv(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime) -> str:
...
def render_runtime_markdown(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime) -> str:
    value = verify_runtime(value)
...
def _documents(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime) -> dict[str, bytes]:
...
def _build_manifest(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest:
    documents = _documents(value)
    receipts = tuple(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact(index, name, len(documents[name]), hash_bytes(documents[name], prefix=ARTIFACT_PREFIX), "pending:runtime-artifact") for index, name in enumerate(ARTIFACT_FILES, 1))
    receipts = tuple(ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact(item.ordinal, item.name, item.size, item.hash, address_artifact(item)) for item in receipts)
    ...
    provisional = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest(**body, manifest_address="pending:runtime-manifest")
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest(**body, manifest_address=address_manifest(provisional))


def manifest_document(value: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime) -> dict[str, Any]:
...
def _compose(runtime: ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime, execution: Any, execution_audit: Any, query: Any, query_audit: Any) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime:
    body = runtime.to_dict()
    return ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime(**body, execution=execution, execution_audit=execution_audit, query=query, query_audit=query_audit)


def load_runtime(destination: str | Path) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime:
    from . import exact_history_diff_archive_transfer_recovery_execution_audit as execution_audit_model
    from . import exact_history_diff_archive_transfer_recovery_execution_query as query_model
    from . import exact_history_diff_archive_transfer_recovery_execution_query_audit as query_audit_model
    ...
    manifest = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest.from_mapping(manifest_raw)
    ...
    for receipt in manifest.artifacts:
        ...
        expected = ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact(receipt.ordinal, receipt.name, len(raw), hash_bytes(raw, prefix=ARTIFACT_PREFIX), "pending:runtime-artifact")
...
def run_runtime(source: str | Path | ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime | execution_model.ExactHistoryDiffArchiveTransferRecoveryExecution, *, runtime_id: str = DEFAULT_RUNTIME_ID, resources: Sequence[str] | None = None, status: str = "", index: int = -1, text: str = "", offset: int = 0, limit: int | None = None, destination: str | Path | None = None, overwrite: bool = False) -> ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime:
    ...
    elif isinstance(source, ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime):
...
__all__ = ["ARTIFACT_FILES", "ARTIFACT_FIELDS", "ARTIFACT_PREFIX", "BOUNDARY", "DEFAULT_RUNTIME_ID", "FILES", "MANIFEST_ARTIFACT_FIELDS", "MANIFEST_FIELDS", "MANIFEST_PREFIX", "MAX_RUNTIME_BYTES", "RUNTIME_FIELDS", "RUNTIME_PREFIX", "STAGE_FIELDS", "STAGE_PREFIX", "STAGES", "STATES", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntime", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeArtifact", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeManifest", "ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeStage", "address_artifact", "address_manifest", "address_runtime", "address_stage", "build_runtime", "capabilities", "load_runtime", "manifest_document", "manifest_schema", "persist_runtime", "render_runtime_markdown", "run_runtime", "runtime_csv", "runtime_from_mapping", "runtime_json", "runtime_schema", "stage_schema", "verify_runtime", "VERSION"]
