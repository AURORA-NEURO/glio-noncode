"""Independent search index assurance plane.
...
class WorkbenchReleaseSearchIndex:
    count: int
    accepted: bool
...
def build_workbench_release_search_index(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseSearchIndex:
    ...
    return WorkbenchReleaseSearchIndex(**body, content_address=content_hash(body))


def validate_workbench_release_search_index(receipt: WorkbenchReleaseSearchIndex, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_search_index(receipt: WorkbenchReleaseSearchIndex) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseSearchIndex", "validate_workbench_release_search_index", "build_workbench_release_search_index", "summarize_workbench_release_search_index"]
