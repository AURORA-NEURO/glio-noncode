"""Independent workbench freshness assurance plane.
...
class WorkbenchReleaseWorkbenchFreshness:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_freshness(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchFreshness:
    ...
    return WorkbenchReleaseWorkbenchFreshness(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_freshness(receipt: WorkbenchReleaseWorkbenchFreshness, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_freshness(receipt: WorkbenchReleaseWorkbenchFreshness) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchFreshness", "validate_workbench_release_workbench_freshness", "build_workbench_release_workbench_freshness", "summarize_workbench_release_workbench_freshness"]
