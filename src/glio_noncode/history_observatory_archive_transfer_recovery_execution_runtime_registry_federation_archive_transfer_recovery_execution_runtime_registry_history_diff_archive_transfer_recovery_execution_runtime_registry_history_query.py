...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow:
...
def address_row(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow):
...
def _row(resource: str, key: str, value: Any, address: str, state: str, accepted: bool, transition: str, ordinal: int) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow:
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow(**(body | {"row_address": address_row(provisional)}))


def _all_rows(value: history_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory) -> tuple[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow, ...]:
    value = history_model.verify_history(value)
    rows: list[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow] = []
...
class HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery:
    ...
    def __init__(self, query_id: str, history_id: str, history_address: str, resources: Sequence[str], state_filter: str, key_filter: str, transition_filter: str, text_filter: str, offset: int, limit: int, total_count: int, returned_count: int, truncated: bool, rows: Sequence[HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.rows = tuple(item if isinstance(item, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow) else HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQueryRow.from_mapping(item) for item in _sequence(rows, "runtime registry history query rows", MAX_LIMIT))
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery:
        value = _mapping(value, "runtime registry history query")
        _strict(value, set(cls.FIELDS), "runtime registry history query")
        return cls(*(value[field] for field in cls.FIELDS))


def address_query(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery) -> str:
    if not isinstance(value, HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery):
        raise ValidationError("runtime registry history query address requires a typed query")
    return content_hash(value.to_dict() | {"content_address": None}, prefix=QUERY_PREFIX)


def query_history(value: history_model.HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistory, *, resources: Sequence[str] | None = None, state: str = "", key: str = "", transition: str = "", text: str = "", offset: int = 0, limit: int = MAX_LIMIT, query_id: str = DEFAULT_QUERY_ID) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery:
    value = history_model.verify_history(value)
    ...
    provisional = HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery(**body)
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery(**(body | {"content_address": address_query(provisional)}))


def query_from_mapping(value: Mapping[str, Any]) -> HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery:
    return HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery.from_mapping(value)


def query_json(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery) -> str:
    return canonical_json(query_from_mapping(value.to_dict()).to_dict())


def query_csv(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery) -> str:
...
def render_query_markdown(value: HistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryQuery) -> str:
    value = query_from_mapping(value.to_dict())
