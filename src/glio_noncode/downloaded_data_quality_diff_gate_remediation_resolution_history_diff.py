...
VERSION = "downloaded-data-quality-diff-gate-remediation-resolution-history-diff-v1"
BOUNDARY = "public_downloaded_data_quality_diff_gate_remediation_resolution_history_diff"
DIFF_PREFIX = "glio-noncode-download-quality-diff-gate-remediation-resolution-history-diff"
...
def _entry_snapshot(value: Mapping[str, Any]) -> dict[str, Any]:
    return history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryEntry.from_mapping(value).to_dict()


class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem:
        value = _mapping(value, "history diff item")
        _strict(value, set(cls.FIELDS), "history diff item")
        return cls(*(value[field] for field in cls.FIELDS))


def address_item(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem):
...
class DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff:
    ...
    def __init__(self, diff_id: str, version: str, boundary: str, left_history_address: str, right_history_address: str, left_entry_count: int, right_entry_count: int, left_latest_required_open_count: int, right_latest_required_open_count: int, left_release_ready: bool, right_release_ready: bool, left_initial_count: int, right_initial_count: int, left_improved_count: int, right_improved_count: int, left_regressed_count: int, right_regressed_count: int, left_unchanged_count: int, right_unchanged_count: int, added_count: int, removed_count: int, changed_count: int, unchanged_count: int, improved_delta: int, regressed_delta: int, direction: str, state_transition: str, items: Sequence[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem | Mapping[str, Any]], content_address: str) -> None:
        ...
        self.items = tuple(item if isinstance(item, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem) else DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem.from_mapping(item) for item in _sequence(items, "history diff items", MAX_ITEMS))
    ...
    def resource_items(self, resource: str) -> tuple[DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem, ...]:
    ...
    @classmethod
    def from_mapping(cls, value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff:
        value = _mapping(value, "history diff")
        _strict(value, set(cls.FIELDS), "history diff")
        return cls(*(value[field] for field in cls.FIELDS))


def address_diff(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff) -> str:
    if not isinstance(value, DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff):
...
def _item(ordinal: int, identity: str, change: str, left: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryEntry | None, right: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistoryEntry | None) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem:
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem(**(body | {"content_address": address_item(provisional)}))


def _state_name(value: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistory) -> str:
    return value.state


def build_diff(left: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistory, right: history_model.DownloadedDataQualityDiffGateRemediationResolutionHistory, *, diff_id: str = DEFAULT_DIFF_ID) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff:
    if not isinstance(left, history_model.DownloadedDataQualityDiffGateRemediationResolutionHistory) or not isinstance(right, history_model.DownloadedDataQualityDiffGateRemediationResolutionHistory):
    ...
    provisional = DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff(**body)
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff(**(body | {"content_address": address_diff(provisional)}))


def diff_from_mapping(value: Mapping[str, Any]) -> DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff:
    return DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff.from_mapping(value)


def diff_json(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff) -> str:
    return canonical_json(diff_from_mapping(value.to_dict()).to_dict())


def diff_csv(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff) -> str:
...
def render_diff_markdown(value: DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff) -> str:
    value = diff_from_mapping(value.to_dict())
...
__all__ = ["BOUNDARY", "CHANGES", "CHANGED_ATTRIBUTES", "DEFAULT_DIFF_ID", "DIFF_FIELDS", "DIFF_PREFIX", "DIRECTIONS", "ITEM_FIELDS", "ITEM_PREFIX", "ITEM_RESOURCES", "MAX_ITEMS", "RESOURCES", "VERSION", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiff", "DownloadedDataQualityDiffGateRemediationResolutionHistoryDiffItem", "address_diff", "address_item", "build_diff", "capabilities", "diff_csv", "diff_from_mapping", "diff_json", "diff_schema", "item_schema", "render_diff_markdown"]
