"""Independent workbench package assurance plane.
...
class WorkbenchReleaseWorkbenchPackage:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_package(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchPackage:
    ...
    return WorkbenchReleaseWorkbenchPackage(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_package(receipt: WorkbenchReleaseWorkbenchPackage, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_package(receipt: WorkbenchReleaseWorkbenchPackage) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchPackage", "validate_workbench_release_workbench_package", "build_workbench_release_workbench_package", "summarize_workbench_release_workbench_package"]
