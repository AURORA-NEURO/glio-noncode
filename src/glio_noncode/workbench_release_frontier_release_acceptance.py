"""Deep release acceptance receipt for workbench release review.
...
class WorkbenchReleaseReleaseAcceptance:
...
def build_workbench_release_release_acceptance(values: Iterable[Any] = (), *, require_non_empty: bool = True) -> WorkbenchReleaseReleaseAcceptance:
    rows = tuple(
        {
            "sequence": index,
    ...
    return WorkbenchReleaseReleaseAcceptance(**body, content_address=content_hash(body))


def validate_workbench_release_release_acceptance(receipt: WorkbenchReleaseReleaseAcceptance) -> bool:
...
__all__ = ["WorkbenchReleaseReleaseAcceptance", "build_workbench_release_release_acceptance", "validate_workbench_release_release_acceptance"]
