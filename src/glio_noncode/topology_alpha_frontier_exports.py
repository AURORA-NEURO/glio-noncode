"""Sanitized manifest, CSV, and Markdown exports for alpha review."""
...
def export_topology_alpha_frontier_manifest(fixture: TopologyAlphaFrontierFixture, evaluation: TopologyAlphaFrontierEvaluation) -> str:
...
def export_topology_alpha_frontier_review_csv(evaluation: TopologyAlphaFrontierEvaluation) -> str:
    buffer = io.StringIO()
...
def render_topology_alpha_frontier_review_markdown(evaluation: TopologyAlphaFrontierEvaluation) -> str:
    lines = ["# Domain 09 topology alpha review", "", "| Record | Operation | Role | State | Issues |", "|---|---|---|---|---|"]
...
def export_topology_alpha_frontier_payload(payload: dict[str, Any]) -> str:
    return json.dumps(payload, sort_keys=True, indent=2)


__all__ = ["export_topology_alpha_frontier_manifest", "export_topology_alpha_frontier_payload", "export_topology_alpha_frontier_review_csv", "render_topology_alpha_frontier_review_markdown"]
