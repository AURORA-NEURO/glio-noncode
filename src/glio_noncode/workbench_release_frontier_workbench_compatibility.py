"""Independent workbench compatibility assurance plane.
...
class WorkbenchReleaseWorkbenchCompatibility:
    count: int
    accepted: bool
...
def build_workbench_release_workbench_compatibility(values: Iterable[Any] = (), *, required: int = 1) -> WorkbenchReleaseWorkbenchCompatibility:
    ...
    return WorkbenchReleaseWorkbenchCompatibility(**body, content_address=content_hash(body))


def validate_workbench_release_workbench_compatibility(receipt: WorkbenchReleaseWorkbenchCompatibility, *, expected: int | None = None) -> bool:
...
def summarize_workbench_release_workbench_compatibility(receipt: WorkbenchReleaseWorkbenchCompatibility) -> Mapping[str, Any]:
...
__all__ = ["WorkbenchReleaseWorkbenchCompatibility", "validate_workbench_release_workbench_compatibility", "build_workbench_release_workbench_compatibility", "summarize_workbench_release_workbench_compatibility"]
