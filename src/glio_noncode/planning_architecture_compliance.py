"""Public-boundary compliance checks for D13 payload projections."""
...
class PlanningArchitectureComplianceReport:
    fixture_id: str
...
def assess_planning_architecture_compliance(
    fixture: PlanningArchitectureFixture | None = None,
) -> PlanningArchitectureComplianceReport:
    ...
    return PlanningArchitectureComplianceReport(
        selected.fixture_id,
        checks,
        all(item["passed"] for item in checks),
        forbidden_keys,
        addressed(body, "planning-compliance"),
    )


def planning_architecture_compliance_summary(
    report: PlanningArchitectureComplianceReport,
) -> dict[str, object]:
    return {
...
__all__ = [
    "PlanningArchitectureComplianceReport",
    "assess_planning_architecture_compliance",
    "planning_architecture_compliance_summary",
]
