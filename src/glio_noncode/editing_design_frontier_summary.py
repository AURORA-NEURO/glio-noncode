...
class EditingDesignSummaryPlane:
    plane_id: str
    values: dict[str, Any]
    accepted: bool
    content_address: str
...
def build_editing_design_summary(**kwargs: Any) -> EditingDesignSummaryPlane:
    ...
    return EditingDesignSummaryPlane(**body, content_address=content_hash(body))

__all__ = ["EditingDesignSummaryPlane", "build_editing_design_summary"]
