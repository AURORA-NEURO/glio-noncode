...
# D395 therefore publishes a compact stable namespace while retaining the
# upstream history identity and addresses in every artifact.
VERSION = "glio-noncode-d395-history-diff-v1"
BOUNDARY = "glio-noncode-d395-history-diff"
