"""Focused regression coverage for the D391 history diff layer."""
...
class D391HistoryDiffTests(unittest.TestCase):
    def test_diff_replays_delta_audit_query_and_identity_guard(self) -> None:
        ...
        source_registry = source_registry_model.build_registry((), registry_id="d391-source-registry")
        source_left = source_history_model.build_history(source_registry, history_id="d391-source-history", snapshot_id="baseline")
        source_right = source_history_model.build_history(source_registry, history_id="d391-source-history", snapshot_id="candidate")
        source_diff = runtime_model.diff_model.build_diff(source_left, source_right, diff_id="d391-source-diff")
        ready_runtime = runtime_model.build_runtime(source_diff, runtime_id="d391-ready-runtime", policy=runtime_model.build_policy("d391-ready-policy", source_diff.diff_id, maximum_changed=1))
        blocked_runtime = runtime_model.build_runtime(source_diff, runtime_id="d391-blocked-runtime", policy=runtime_model.build_policy("d391-blocked-policy", source_diff.diff_id, maximum_changed=0))
        blocked_registry = registry_model.build_registry((blocked_runtime,), registry_id="d391-registry")
        ready_registry = registry_model.build_registry((ready_runtime,), registry_id="d391-registry")
        baseline = history_model.build_history(blocked_registry, history_id="d391-history", snapshot_id="baseline")
        ...
        value = diff_model.build_diff(baseline, candidate, diff_id="d391-diff")
        ...
        foreign_registry = registry_model.build_registry((ready_runtime,), registry_id="d391-foreign-registry")
        with self.assertRaises(ValidationError):
            diff_model.build_diff(baseline, history_model.build_history(foreign_registry, history_id="d391-history", snapshot_id="foreign"), diff_id="d391-foreign")
