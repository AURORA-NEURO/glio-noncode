"""Regression coverage for history-diff archive recovery execution receipts."""
...
from glio_noncode import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_audit as execution_audit_model
from glio_noncode import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_query as execution_query_model
from glio_noncode import history_observatory_archive_transfer_recovery_execution_runtime_registry_federation_archive_transfer_recovery_execution_runtime_registry_history_diff_archive_transfer_recovery_execution_query_audit as execution_query_audit_model
...
API_PATH = transfer_test_module.API_PATH + "/recovery/execution"


class HistoryObservatoryArchiveTransferRecoveryExecutionRuntimeRegistryFederationArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffArchiveTransferRecoveryExecutionTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def _partial(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            return transfer, partial, recovery, payload
    ...
    def test_execution_progress_complete_blocked_and_independent_audits(self):
        ...
        self.assertEqual((query.total_count, query.returned_count, query.truncated, query_audit.check_count, query_audit.passed), (9, 5, True, 12, True))
        ...
        self.assertNotIn("payload_bytes", execution_model.execution_json(progress))
        self.assertNotIn("source_path", execution_model.execution_json(progress))
    ...
    def test_cli_api_schemas_and_public_inventory(self):
        ...
        self.assertEqual((inventory.surface_count, inventory.passed_surface_count, inventory.failed_surface_count, inventory.accepted), (1817, 1817, 0, True))
