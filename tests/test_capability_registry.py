...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 185)
        self.assertEqual(coverage.planned, 68)
        ...
        self.assertEqual(coverage.started, 188)
        self.assertAlmostEqual(coverage.started_percent, 73.44)
        ...
        self.assertEqual(registry.record("GNC-D01-C09").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D01-C12").state, CapabilityState.PARTIAL)
        ...
        self.assertEqual(registry.record("GNC-D02-C12").state, CapabilityState.PARTIAL)
        ...
        self.assertEqual(registry.record("GNC-D03-C09").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D03-C12").state, CapabilityState.PARTIAL)
        ...
        self.assertEqual(registry.record("GNC-D04-C09").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D04-C12").state, CapabilityState.PARTIAL)
        ...
        self.assertEqual(registry.record("GNC-D05-C09").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D05-C12").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D06-C09").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D06-C12").state, CapabilityState.PARTIAL)
        ...
        self.assertEqual(registry.record("GNC-D09-C08").state, CapabilityState.PARTIAL)
        ...
        self.assertEqual(registry.record("GNC-D15-C05").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D15-C08").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D15-C09").state, CapabilityState.PARTIAL)
        self.assertEqual(registry.record("GNC-D15-C12").state, CapabilityState.PARTIAL)
