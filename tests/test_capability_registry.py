...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 57)
        self.assertEqual(coverage.planned, 196)
        ...
        self.assertEqual(coverage.started, 60)
        self.assertAlmostEqual(coverage.started_percent, 23.44)
        self.assertEqual(coverage.mvp_started, 60)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 93.75)
