...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 13)
        self.assertEqual(coverage.planned, 240)
        ...
        self.assertEqual(coverage.started, 16)
        self.assertAlmostEqual(coverage.started_percent, 6.25)
        self.assertEqual(coverage.mvp_started, 16)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 25.0)
