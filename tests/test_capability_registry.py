...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.verified, 244)
        self.assertEqual(coverage.partial, 12)
        self.assertEqual(coverage.planned, 0)
        self.assertAlmostEqual(coverage.implementation_percent, 95.31)
        ...
        self.assertEqual(registry.record("GNC-D09-C09").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D09-C12").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C01").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C02").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C03").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C04").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C05").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C06").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C07").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C08").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C09").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C10").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C11").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D10-C12").state, CapabilityState.VERIFIED)
        ...
        for capability_id in ("GNC-D11-C05", "GNC-D11-C06", "GNC-D11-C07", "GNC-D11-C08"):
            self.assertEqual(registry.record(capability_id).state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D11-C09").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D11-C12").state, CapabilityState.VERIFIED)
        for capability_id in ("GNC-D12-C01", "GNC-D12-C02", "GNC-D12-C03", "GNC-D12-C04"):
            self.assertEqual(registry.record(capability_id).state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D12-C05").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D12-C08").state, CapabilityState.VERIFIED)
        for capability_id in ("GNC-D12-C09", "GNC-D12-C10", "GNC-D12-C11", "GNC-D12-C12"):
            self.assertEqual(registry.record(capability_id).state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D13-C05").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D13-C08").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D13-C09").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D13-C12").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D14-C05").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D14-C08").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D14-C09").state, CapabilityState.VERIFIED)
        self.assertEqual(registry.record("GNC-D14-C12").state, CapabilityState.VERIFIED)
