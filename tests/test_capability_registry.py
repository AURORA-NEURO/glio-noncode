...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 17)
        self.assertEqual(coverage.planned, 236)
        ...
        self.assertEqual(coverage.started, 20)
        self.assertAlmostEqual(coverage.started_percent, 7.81)
        self.assertEqual(coverage.mvp_started, 20)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 31.25)
