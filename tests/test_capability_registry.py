...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 101)
        self.assertEqual(coverage.planned, 152)
        ...
        self.assertEqual(coverage.started, 104)
        self.assertAlmostEqual(coverage.started_percent, 40.62)
