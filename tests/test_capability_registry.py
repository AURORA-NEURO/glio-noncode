...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 93)
        self.assertEqual(coverage.planned, 160)
        ...
        self.assertEqual(coverage.started, 96)
        self.assertAlmostEqual(coverage.started_percent, 37.5)
