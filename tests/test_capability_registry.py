...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 137)
        self.assertEqual(coverage.planned, 116)
        ...
        self.assertEqual(coverage.started, 140)
        self.assertAlmostEqual(coverage.started_percent, 54.69)
