...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 109)
        self.assertEqual(coverage.planned, 144)
        ...
        self.assertEqual(coverage.started, 112)
        self.assertAlmostEqual(coverage.started_percent, 43.75)
