...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 177)
        self.assertEqual(coverage.planned, 76)
        ...
        self.assertEqual(coverage.started, 180)
        self.assertAlmostEqual(coverage.started_percent, 70.31)
