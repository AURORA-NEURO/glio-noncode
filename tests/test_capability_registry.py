...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 121)
        self.assertEqual(coverage.planned, 132)
        ...
        self.assertEqual(coverage.started, 124)
        self.assertAlmostEqual(coverage.started_percent, 48.44)
