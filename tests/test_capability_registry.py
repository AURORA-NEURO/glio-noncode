...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 169)
        self.assertEqual(coverage.planned, 84)
        ...
        self.assertEqual(coverage.started, 172)
        self.assertAlmostEqual(coverage.started_percent, 67.19)
