...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 77)
        self.assertEqual(coverage.planned, 176)
        ...
        self.assertEqual(coverage.started, 80)
        self.assertAlmostEqual(coverage.started_percent, 31.25)
