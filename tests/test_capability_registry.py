...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 29)
        self.assertEqual(coverage.planned, 224)
        ...
        self.assertEqual(coverage.started, 32)
        self.assertAlmostEqual(coverage.started_percent, 12.5)
        self.assertEqual(coverage.mvp_started, 32)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 50.0)
