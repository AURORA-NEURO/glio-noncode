...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 97)
        self.assertEqual(coverage.planned, 156)
        ...
        self.assertEqual(coverage.started, 100)
        self.assertAlmostEqual(coverage.started_percent, 39.06)
