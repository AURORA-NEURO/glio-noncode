...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 73)
        self.assertEqual(coverage.planned, 180)
        ...
        self.assertEqual(coverage.started, 76)
        self.assertAlmostEqual(coverage.started_percent, 29.69)
