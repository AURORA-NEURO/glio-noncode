...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 89)
        self.assertEqual(coverage.planned, 164)
        ...
        self.assertEqual(coverage.started, 92)
        self.assertAlmostEqual(coverage.started_percent, 35.94)
