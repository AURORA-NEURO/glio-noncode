...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 125)
        self.assertEqual(coverage.planned, 128)
        ...
        self.assertEqual(coverage.started, 128)
        self.assertAlmostEqual(coverage.started_percent, 50.0)
