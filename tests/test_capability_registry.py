...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 37)
        self.assertEqual(coverage.planned, 216)
        ...
        self.assertEqual(coverage.started, 40)
        self.assertAlmostEqual(coverage.started_percent, 15.62)
        self.assertEqual(coverage.mvp_started, 40)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 62.5)
