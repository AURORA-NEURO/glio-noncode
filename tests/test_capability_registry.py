...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 81)
        self.assertEqual(coverage.planned, 172)
        ...
        self.assertEqual(coverage.started, 84)
        self.assertAlmostEqual(coverage.started_percent, 32.81)
