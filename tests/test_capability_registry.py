...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 105)
        self.assertEqual(coverage.planned, 148)
        ...
        self.assertEqual(coverage.started, 108)
        self.assertAlmostEqual(coverage.started_percent, 42.19)
