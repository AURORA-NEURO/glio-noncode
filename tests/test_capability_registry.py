...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.verified, 180)
        self.assertEqual(coverage.partial, 76)
        self.assertEqual(coverage.planned, 0)
        self.assertAlmostEqual(coverage.implementation_percent, 70.31)
        self.assertAlmostEqual(coverage.mvp_implementation_percent, 68.75)
