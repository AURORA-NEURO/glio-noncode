...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 173)
        self.assertEqual(coverage.planned, 80)
        ...
        self.assertEqual(coverage.started, 176)
        self.assertAlmostEqual(coverage.started_percent, 68.75)
