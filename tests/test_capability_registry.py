...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 157)
        self.assertEqual(coverage.planned, 96)
        ...
        self.assertEqual(coverage.started, 160)
        self.assertAlmostEqual(coverage.started_percent, 62.5)
