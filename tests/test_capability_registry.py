...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 117)
        self.assertEqual(coverage.planned, 136)
        ...
        self.assertEqual(coverage.started, 120)
        self.assertAlmostEqual(coverage.started_percent, 46.88)
