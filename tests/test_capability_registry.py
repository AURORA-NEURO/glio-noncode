...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 25)
        self.assertEqual(coverage.planned, 228)
        ...
        self.assertEqual(coverage.started, 28)
        self.assertAlmostEqual(coverage.started_percent, 10.94)
        self.assertEqual(coverage.mvp_started, 28)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 43.75)
