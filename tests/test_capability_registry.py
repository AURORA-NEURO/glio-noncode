...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 33)
        self.assertEqual(coverage.planned, 220)
        ...
        self.assertEqual(coverage.started, 36)
        self.assertAlmostEqual(coverage.started_percent, 14.06)
        self.assertEqual(coverage.mvp_started, 36)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 56.25)
