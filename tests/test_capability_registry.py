...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 65)
        self.assertEqual(coverage.planned, 188)
        ...
        self.assertEqual(coverage.started, 68)
        self.assertAlmostEqual(coverage.started_percent, 26.56)
