...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 41)
        self.assertEqual(coverage.planned, 212)
        ...
        self.assertEqual(coverage.started, 44)
        self.assertAlmostEqual(coverage.started_percent, 17.19)
        self.assertEqual(coverage.mvp_started, 44)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 68.75)
