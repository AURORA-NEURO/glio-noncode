...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 149)
        self.assertEqual(coverage.planned, 104)
        ...
        self.assertEqual(coverage.started, 152)
        self.assertAlmostEqual(coverage.started_percent, 59.38)
