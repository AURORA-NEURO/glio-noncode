...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 165)
        self.assertEqual(coverage.planned, 88)
        ...
        self.assertEqual(coverage.started, 168)
        self.assertAlmostEqual(coverage.started_percent, 65.62)
