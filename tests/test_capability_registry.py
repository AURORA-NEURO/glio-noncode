...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 181)
        self.assertEqual(coverage.planned, 72)
        ...
        self.assertEqual(coverage.started, 184)
        self.assertAlmostEqual(coverage.started_percent, 71.88)
