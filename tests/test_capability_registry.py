...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 133)
        self.assertEqual(coverage.planned, 120)
        ...
        self.assertEqual(coverage.started, 136)
        self.assertAlmostEqual(coverage.started_percent, 53.12)
