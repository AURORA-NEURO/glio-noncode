...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 153)
        self.assertEqual(coverage.planned, 100)
        ...
        self.assertEqual(coverage.started, 156)
        self.assertAlmostEqual(coverage.started_percent, 60.94)
