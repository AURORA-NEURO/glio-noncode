...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 5)
        self.assertEqual(coverage.planned, 248)
        ...
        self.assertEqual(coverage.started, 8)
        self.assertAlmostEqual(coverage.started_percent, 3.12)
        self.assertEqual(coverage.mvp_started, 8)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 12.5)
