...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 49)
        self.assertEqual(coverage.planned, 204)
        ...
        self.assertEqual(coverage.started, 52)
        self.assertAlmostEqual(coverage.started_percent, 20.31)
        self.assertEqual(coverage.mvp_started, 52)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 81.25)
