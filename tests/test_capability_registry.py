...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 141)
        self.assertEqual(coverage.planned, 112)
        ...
        self.assertEqual(coverage.started, 144)
        self.assertAlmostEqual(coverage.started_percent, 56.25)
