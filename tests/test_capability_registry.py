...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 161)
        self.assertEqual(coverage.planned, 92)
        ...
        self.assertEqual(coverage.started, 164)
        self.assertAlmostEqual(coverage.started_percent, 64.06)
