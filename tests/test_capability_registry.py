...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 21)
        self.assertEqual(coverage.planned, 232)
        ...
        self.assertEqual(coverage.started, 24)
        self.assertAlmostEqual(coverage.started_percent, 9.38)
        self.assertEqual(coverage.mvp_started, 24)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 37.5)
