...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 61)
        self.assertEqual(coverage.planned, 192)
        ...
        self.assertEqual(coverage.started, 64)
        self.assertAlmostEqual(coverage.started_percent, 25.0)
