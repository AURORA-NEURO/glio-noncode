...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 45)
        self.assertEqual(coverage.planned, 208)
        ...
        self.assertEqual(coverage.started, 48)
        self.assertAlmostEqual(coverage.started_percent, 18.75)
        self.assertEqual(coverage.mvp_started, 48)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 75.0)
