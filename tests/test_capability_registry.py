...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 113)
        self.assertEqual(coverage.planned, 140)
        ...
        self.assertEqual(coverage.started, 116)
        self.assertAlmostEqual(coverage.started_percent, 45.31)
