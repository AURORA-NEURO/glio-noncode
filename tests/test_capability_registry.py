...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 9)
        self.assertEqual(coverage.planned, 244)
        ...
        self.assertEqual(coverage.started, 12)
        self.assertAlmostEqual(coverage.started_percent, 4.69)
        self.assertEqual(coverage.mvp_started, 12)
        self.assertAlmostEqual(coverage.to_dict()["mvp_started_percent"], 18.75)
