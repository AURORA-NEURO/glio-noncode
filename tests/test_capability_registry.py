...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.verified, 124)
        self.assertEqual(coverage.partial, 132)
        self.assertEqual(coverage.planned, 0)
        self.assertAlmostEqual(coverage.implementation_percent, 48.44)
        self.assertAlmostEqual(coverage.mvp_implementation_percent, 37.5)
