...
class CapabilityRegistryTests(unittest.TestCase):
    def test_blueprint_catalog_has_256_rows_and_64_mvp_rows(self) -> None:
        ...
        self.assertEqual(coverage.partial, 145)
        self.assertEqual(coverage.planned, 108)
        ...
        self.assertEqual(coverage.started, 148)
        self.assertAlmostEqual(coverage.started_percent, 57.81)
