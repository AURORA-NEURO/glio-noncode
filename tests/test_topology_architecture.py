...
class TopologyArchitectureTests(unittest.TestCase):
    ...
    def test_runtime_release_depth_compliance_and_replay_close(self) -> None:
        ...
        self.assertEqual(runtime.depth.family_count, 4)
        self.assertGreaterEqual(runtime.depth.state_count, 4)
        self.assertGreaterEqual(runtime.depth.issue_code_count, 3)
