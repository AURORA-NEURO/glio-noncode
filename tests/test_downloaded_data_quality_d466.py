"""Focused regression coverage for the D466 registry history layer."""
...
class D466RegistryHistoryTests(unittest.TestCase):
    def test_history_replays_append_query_and_head_guards(self) -> None:
        ...
        def runtime(runtime_id: str, state: str, release_ready: bool, address: str) -> dict[str, object]:
            return {
                ...
                "diff_id": "d466-diff",
                "diff_address": "glio-noncode-d466-diff:fixture",
                "state": state,
        ...
        blocked_registry = history_model.build_registry_snapshot(
            (runtime("d466-blocked-runtime", "blocked", False, "glio-noncode-d466-runtime:blocked"),),
            registry_id="d466-registry",
        )
        ready_registry = history_model.build_registry_snapshot(
            (runtime("d466-ready-runtime", "ready", True, "glio-noncode-d466-runtime:ready"),),
            registry_id="d466-registry",
        )
        history = history_model.build_history(blocked_registry, history_id="d466-history", snapshot_id="blocked")
