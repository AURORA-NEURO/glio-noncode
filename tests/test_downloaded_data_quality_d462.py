"""Focused regression coverage for the D462 registry history layer."""
...
class D462RegistryHistoryTests(unittest.TestCase):
    def test_history_replays_append_query_and_head_guards(self) -> None:
        ...
        def runtime(runtime_id: str, state: str, release_ready: bool, address: str) -> dict[str, object]:
            return {
                ...
                "diff_id": "d462-diff",
                "diff_address": "glio-noncode-d462-diff:fixture",
                "state": state,
        ...
        blocked_registry = history_model.build_registry_snapshot(
            (runtime("d462-blocked-runtime", "blocked", False, "glio-noncode-d462-runtime:blocked"),),
            registry_id="d462-registry",
        )
        ready_registry = history_model.build_registry_snapshot(
            (runtime("d462-ready-runtime", "ready", True, "glio-noncode-d462-runtime:ready"),),
            registry_id="d462-registry",
        )
        history = history_model.build_history(blocked_registry, history_id="d462-history", snapshot_id="blocked")
