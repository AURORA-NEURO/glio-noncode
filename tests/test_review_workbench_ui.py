...
class ReviewWorkbenchUiTests(unittest.TestCase):
    def test_workbench_supports_skip_navigation_and_concise_selection_status(self) -> None:
        ...
        self.assertIn('id="module-workbench-cache-state"', html)
        self.assertIn('id="module-workbench-cache-mode"', html)
        self.assertIn('id="module-workbench-cache-reused"', html)
        self.assertIn('id="module-workbench-cache-reparsed"', html)
        self.assertIn('id="module-workbench-cache-inputs"', html)
        self.assertIn('id="module-workbench-cache-summary"', html)
        ...
        self.assertIn("/v1/module-workbench/observability", javascript)
        self.assertIn("moduleWorkbenchObservation", javascript)
        self.assertIn("invalid module workbench cache provenance", javascript)
        ...
        self.assertIn('id="module-execution-batch-button"', html)
        self.assertIn('id="module-execution-batch-size"', html)
        self.assertIn('id="module-execution-batch-state"', html)
        self.assertIn('id="module-execution-packet-state"', html)
        self.assertIn('id="module-execution-packet-download"', html)
        self.assertIn('id="module-execution-packet-artifact-table"', html)
        self.assertIn("function previewModuleExecutionPlan()", javascript)
        self.assertIn("function executeReadyModuleWave()", javascript)
        self.assertIn("/v1/module-workbench/execution/commands", javascript)
        self.assertIn("result.atomic !== true", javascript)
        self.assertIn("one durable batch", javascript)
        ...
        self.assertIn("function renderModuleExecutionPacket()", javascript)
        self.assertIn("/v1/module-workbench/execution/packet/archive.zip", javascript)
        self.assertIn("Execution packet integrity", html)
