"""Regression coverage for exact runtime-registry history comparison."""
...
from glio_noncode import exact_history_diff_archive_transfer_recovery_execution_runtime_registry_history_diff_audit as diff_audit_model
from glio_noncode import exact_history_diff_archive_transfer_recovery_execution_runtime_registry_history_diff_query as diff_query_model
from glio_noncode import exact_history_diff_archive_transfer_recovery_execution_runtime_registry_history_diff_query_audit as diff_query_audit_model
...
class ExactHistoryDiffArchiveTransferRecoveryExecutionRuntimeRegistryHistoryDiffTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def _histories(cls, root: Path):
        ...
        runtime = registry_tests._runtime("downloaded-real-history-diff-runtime")
        candidate_runtime = registry_tests._runtime("downloaded-real-history-diff-candidate-runtime")
