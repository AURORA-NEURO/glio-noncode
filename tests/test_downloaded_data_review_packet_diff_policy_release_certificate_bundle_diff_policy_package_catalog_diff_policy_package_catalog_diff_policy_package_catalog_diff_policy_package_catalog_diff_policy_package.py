    ...
    def test_cli_http_schema_and_query_surfaces(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                ...
                base = "/v1/downloaded-data/review-packet/diff/policy/release-certificate/bundle/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package"
