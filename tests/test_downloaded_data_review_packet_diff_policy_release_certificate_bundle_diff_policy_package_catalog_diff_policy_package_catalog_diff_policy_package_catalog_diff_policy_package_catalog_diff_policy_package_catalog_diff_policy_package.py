...
class DownloadedDataReviewPacketPolicyHandoffCatalogReviewPacketTest(unittest.TestCase):
    ...
    def test_deterministic_round_trip_and_independent_audit(self) -> None:
        first = build_package(self.diff, self.policy, self.policy_audit, package_id="policy-handoff-review-packet")
        second = build_package(self.diff, self.policy, self.policy_audit, package_id="policy-handoff-review-packet")
    ...
    def test_blocked_evidence_persistence_and_tamper_rejection(self) -> None:
        ...
        packet = build_package(self.diff, blocked, blocked_audit, package_id="policy-handoff-review-packet-blocked")
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            write_package(packet, destination)
            self.assertEqual(verify_package(destination).package_address, packet.package_address)
    ...
    def test_cli_http_schema_and_query_surfaces(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                ...
                base = "/v1/downloaded-data/review-packet/diff/policy/release-certificate/bundle/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package"
