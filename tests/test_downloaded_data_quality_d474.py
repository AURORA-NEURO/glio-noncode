"""Focused regression coverage for the D474 registry history layer."""
...
class D474RegistryHistoryTests(unittest.TestCase):
    def test_history_replays_append_query_and_head_guards(self) -> None:
        ...
        def runtime(runtime_id: str, state: str, release_ready: bool, address: str) -> dict[str, object]:
            return {
                ...
                "diff_id": "d474-diff",
                "diff_address": "glio-noncode-d474-diff:fixture",
                "state": state,
        ...
        blocked_registry = history_model.build_registry_snapshot(
            (runtime("d474-blocked-runtime", "blocked", False, "glio-noncode-d474-runtime:blocked"),),
            registry_id="d474-registry",
        )
        ready_registry = history_model.build_registry_snapshot(
            (runtime("d474-ready-runtime", "ready", True, "glio-noncode-d474-runtime:ready"),),
            registry_id="d474-registry",
        )
        history = history_model.build_history(blocked_registry, history_id="d474-history", snapshot_id="blocked")
