"""Focused regression coverage for the D470 registry history layer."""
...
class D470RegistryHistoryTests(unittest.TestCase):
    def test_history_replays_append_query_and_head_guards(self) -> None:
        ...
        def runtime(runtime_id: str, state: str, release_ready: bool, address: str) -> dict[str, object]:
            return {
                ...
                "diff_id": "d470-diff",
                "diff_address": "glio-noncode-d470-diff:fixture",
                "state": state,
        ...
        blocked_registry = history_model.build_registry_snapshot(
            (runtime("d470-blocked-runtime", "blocked", False, "glio-noncode-d470-runtime:blocked"),),
            registry_id="d470-registry",
        )
        ready_registry = history_model.build_registry_snapshot(
            (runtime("d470-ready-runtime", "ready", True, "glio-noncode-d470-runtime:ready"),),
            registry_id="d470-registry",
        )
        history = history_model.build_history(blocked_registry, history_id="d470-history", snapshot_id="blocked")
