...
class WorkbenchArchitectureCliTests(unittest.TestCase):
    def test_fixture_evaluation_runtime_and_report_commands(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(main(["workbench-architecture-fixture", "--output", str(fixture)]), 0)
            self.assertEqual(
                main(
                    [
                        "evaluate-workbench-architecture",
                        "--input",
                        str(fixture),
                        "--output",
                        str(evaluation),
            ...
            self.assertEqual(
                main(
                    [
                        "workbench-architecture-runtime",
                        "--input",
                        str(fixture),
                        "--output",
                        str(runtime),
