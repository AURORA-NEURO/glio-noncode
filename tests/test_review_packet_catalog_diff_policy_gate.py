"""Coverage for policy gates over source-free review-packet catalog diffs."""
...
class HandoffCatalogDiffPolicyTest(unittest.TestCase):
    ...
    def test_cli_http_schema_and_query_contracts(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            command = "downloaded-data-review-packet-diff-policy-release-certificate-bundle-diff-policy-package-catalog-diff-policy-package-catalog-diff-policy-package-catalog-diff-policy-package-catalog-diff-policy-package-catalog-diff-policy-package-catalog-diff-policy"
            ...
            thread.start()
            try:
                base = "/v1/downloaded-data/review-packet/diff/policy/release-certificate/bundle/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy/package/catalog/diff/policy"
