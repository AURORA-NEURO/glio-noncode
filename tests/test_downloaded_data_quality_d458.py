"""Focused regression coverage for the D458 registry history layer."""
...
class D458RegistryHistoryTests(unittest.TestCase):
    def test_history_replays_append_query_and_head_guards(self) -> None:
        ...
        def runtime(runtime_id: str, state: str, release_ready: bool, address: str) -> dict[str, object]:
            return {
                ...
                "diff_id": "d458-diff",
                "diff_address": "glio-noncode-d458-diff:fixture",
                "state": state,
        ...
        blocked_registry = history_model.build_registry_snapshot(
            (runtime("d458-blocked-runtime", "blocked", False, "glio-noncode-d458-runtime:blocked"),),
            registry_id="d458-registry",
        )
        ready_registry = history_model.build_registry_snapshot(
            (runtime("d458-ready-runtime", "ready", True, "glio-noncode-d458-runtime:ready"),),
            registry_id="d458-registry",
        )
        history = history_model.build_history(blocked_registry, history_id="d458-history", snapshot_id="blocked")
