...
class PlanningArchitectureCliTests(unittest.TestCase):
    def test_fixture_evaluation_runtime_and_report_commands(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(main(["planning-architecture-fixture", "--output", str(fixture)]), 0)
            self.assertEqual(
                main(
                    [
                        "evaluate-planning-architecture",
                        "--input",
                        str(fixture),
                        "--output",
                        str(evaluation),
